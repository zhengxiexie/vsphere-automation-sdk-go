...
func SourceInfoBindingType() vapiBindings_.BindingType {
	...
	return vapiBindings_.NewStructType("com.vmware.vapi.metadata.cli.source.info", fields, reflect.TypeOf(SourceInfo{}), fieldNameMap, validators)
}
...
func SourceCreateSpecBindingType() vapiBindings_.BindingType {
	...
	validators = append(validators, uv1)
	return vapiBindings_.NewStructType("com.vmware.vapi.metadata.cli.source.create_spec", fields, reflect.TypeOf(SourceCreateSpec{}), fieldNameMap, validators)
}
