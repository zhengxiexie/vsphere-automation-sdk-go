...
func sourceCreateInputType() vapiBindings_.StructType {
	...
	fields["source_id"] = vapiBindings_.NewIdType([]string{"com.vmware.vapi.metadata.privilege.source"}, "")
...
func sourceDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["source_id"] = vapiBindings_.NewIdType([]string{"com.vmware.vapi.metadata.privilege.source"}, "")
	fieldNameMap["source_id"] = "SourceId"
	paramsTypeMap["source_id"] = vapiBindings_.NewIdType([]string{"com.vmware.vapi.metadata.privilege.source"}, "")
	paramsTypeMap["sourceId"] = vapiBindings_.NewIdType([]string{"com.vmware.vapi.metadata.privilege.source"}, "")
...
func SourceListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewListType(vapiBindings_.NewIdType([]string{"com.vmware.vapi.metadata.privilege.source"}, ""), reflect.TypeOf([]string{}))
}
...
func sourceReloadInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["source_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewIdType([]string{"com.vmware.vapi.metadata.privilege.source"}, ""))
	fieldNameMap["source_id"] = "SourceId"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func SourceInfoBindingType() vapiBindings_.BindingType {
	...
	return vapiBindings_.NewStructType("com.vmware.vapi.metadata.privilege.source.info", fields, reflect.TypeOf(SourceInfo{}), fieldNameMap, validators)
}
...
func SourceCreateSpecBindingType() vapiBindings_.BindingType {
	...
	validators = append(validators, uv1)
	return vapiBindings_.NewStructType("com.vmware.vapi.metadata.privilege.source.create_spec", fields, reflect.TypeOf(SourceCreateSpec{}), fieldNameMap, validators)
}
