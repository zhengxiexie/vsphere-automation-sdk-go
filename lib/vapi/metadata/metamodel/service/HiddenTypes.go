...
func hiddenListInputType() vapiBindings_.StructType {
...
func HiddenListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewListType(vapiBindings_.NewIdType([]string{"com.vmware.vapi.service"}, ""), reflect.TypeOf([]string{}))
}

func hiddenListRestMetadata() vapiProtocol_.OperationRestMetadata {
