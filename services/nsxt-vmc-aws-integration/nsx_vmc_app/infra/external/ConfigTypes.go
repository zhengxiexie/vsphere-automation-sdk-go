...
func ConfigGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_vmc_appModel.ExternalConnectivityConfigBindingType)
}
...
func configUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["external_connectivity_config"] = vapiBindings_.NewReferenceType(nsx_vmc_appModel.ExternalConnectivityConfigBindingType)
...
func configUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["external_connectivity_config"] = vapiBindings_.NewReferenceType(nsx_vmc_appModel.ExternalConnectivityConfigBindingType)
	fieldNameMap["external_connectivity_config"] = "ExternalConnectivityConfig"
	paramsTypeMap["external_connectivity_config"] = vapiBindings_.NewReferenceType(nsx_vmc_appModel.ExternalConnectivityConfigBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
