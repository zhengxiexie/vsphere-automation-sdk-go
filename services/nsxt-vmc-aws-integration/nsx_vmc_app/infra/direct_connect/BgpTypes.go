...
func BgpGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_vmc_appModel.DirectConnectBgpInfoBindingType)
}
...
func bgpPatchInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["direct_connect_bgp_info"] = vapiBindings_.NewReferenceType(nsx_vmc_appModel.DirectConnectBgpInfoBindingType)
...
func bgpPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["direct_connect_bgp_info"] = vapiBindings_.NewReferenceType(nsx_vmc_appModel.DirectConnectBgpInfoBindingType)
	fieldNameMap["direct_connect_bgp_info"] = "DirectConnectBgpInfo"
	paramsTypeMap["direct_connect_bgp_info"] = vapiBindings_.NewReferenceType(nsx_vmc_appModel.DirectConnectBgpInfoBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
