...
func memberStatusListInputType() vapiBindings_.StructType {
...
func MemberStatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.HostNodeStatusListResultBindingType)
}

func memberStatusListRestMetadata() vapiProtocol_.OperationRestMetadata {
