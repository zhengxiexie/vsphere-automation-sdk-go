...
type StateClient interface {
	...
	Get(computeManagerIdParam string) (nsxModel.ConfigurationState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.fabric.compute_managers.state")
...
func (sIface *stateClient) Get(computeManagerIdParam string) (nsxModel.ConfigurationState, error) {
