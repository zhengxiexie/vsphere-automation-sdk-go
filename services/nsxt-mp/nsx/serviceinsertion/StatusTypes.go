...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ServiceInsertionStatusBindingType)
}
...
func StatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ServiceInsertionStatusListResultBindingType)
}
...
func statusUpdateInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["context_type"] = vapiBindings_.NewStringType()
	fields["service_insertion_status"] = vapiBindings_.NewReferenceType(nsxModel.ServiceInsertionStatusBindingType)
	fieldNameMap["context_type"] = "ContextType"
...
func statusUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["service_insertion_status"] = "ServiceInsertionStatus"
	paramsTypeMap["context_type"] = vapiBindings_.NewStringType()
	paramsTypeMap["service_insertion_status"] = vapiBindings_.NewReferenceType(nsxModel.ServiceInsertionStatusBindingType)
	paramsTypeMap["contextType"] = vapiBindings_.NewStringType()
	pathParams["context_type"] = "contextType"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
