...
type StateClient interface {
	...
	Get(serviceIdParam string, serviceDeploymentIdParam string) (nsxModel.ConfigurationState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_deployments.state")
...
func (sIface *stateClient) Get(serviceIdParam string, serviceDeploymentIdParam string) (nsxModel.ConfigurationState, error) {
