...
type StatusClient interface {
	...
	Get(serviceIdParam string, serviceDeploymentIdParam string, sourceParam *string) (nsxModel.ServiceDeploymentStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_deployments.status")
...
func (sIface *statusClient) Get(serviceIdParam string, serviceDeploymentIdParam string, sourceParam *string) (nsxModel.ServiceDeploymentStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.ServiceDeploymentStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.ServiceDeploymentStatus), nil
	} else {
