...
type StatusClient interface {
	...
	Get(serviceIdParam string, serviceInstanceIdParam string, sourceParam *string) (nsxModel.ServiceInstanceStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_instances.status")
...
func (sIface *statusClient) Get(serviceIdParam string, serviceInstanceIdParam string, sourceParam *string) (nsxModel.ServiceInstanceStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.ServiceInstanceStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.ServiceInstanceStatus), nil
	} else {
