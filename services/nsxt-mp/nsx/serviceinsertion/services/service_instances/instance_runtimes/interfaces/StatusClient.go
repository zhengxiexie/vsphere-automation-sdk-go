...
type StatusClient interface {
	...
	Get(serviceIdParam string, serviceInstanceIdParam string, instanceRuntimeIdParam string, interfaceIndexParam string, sourceParam *string) (nsxModel.RuntimeInterfaceOperationalStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_instances.instance_runtimes.interfaces.status")
...
func (sIface *statusClient) Get(serviceIdParam string, serviceInstanceIdParam string, instanceRuntimeIdParam string, interfaceIndexParam string, sourceParam *string) (nsxModel.RuntimeInterfaceOperationalStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.RuntimeInterfaceOperationalStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.RuntimeInterfaceOperationalStatus), nil
	} else {
