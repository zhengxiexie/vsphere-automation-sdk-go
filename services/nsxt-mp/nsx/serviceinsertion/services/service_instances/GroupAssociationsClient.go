...
type GroupAssociationsClient interface {
	...
	Get(serviceIdParam string, serviceInstanceIdParam string) (nsxModel.ServiceInstanceNSGroups, error)
}
...
func NewGroupAssociationsClient(connector vapiProtocolClient_.Connector) *groupAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_instances.group_associations")
...
func (gIface *groupAssociationsClient) Get(serviceIdParam string, serviceInstanceIdParam string) (nsxModel.ServiceInstanceNSGroups, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.ServiceInstanceNSGroups
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.ServiceInstanceNSGroups), nil
	} else {
