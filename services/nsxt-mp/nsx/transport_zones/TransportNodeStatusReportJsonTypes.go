...
func TransportNodeStatusReportJsonGetallOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.TransportNodeStatusReportListResultBindingType)
}
...
func transportNodeStatusReportJsonGetallRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/transport-zones/transport-node-status-report-json",
		"",
		resultHeaders,
		200,
		"",
...
func TransportNodeStatusReportJsonListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.TransportNodeStatusReportListResultBindingType)
}

func transportNodeStatusReportJsonListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/transport-zones/{zoneId}/transport-node-status-report-json",
		"",
		resultHeaders,
		200,
		"",
