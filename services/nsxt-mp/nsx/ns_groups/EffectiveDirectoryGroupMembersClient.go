...
func NewEffectiveDirectoryGroupMembersClient(connector vapiProtocolClient_.Connector) *effectiveDirectoryGroupMembersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.ns_groups.effective_directory_group_members")
...
func (eIface *effectiveDirectoryGroupMembersClient) GetErrorBindingType(errorName string) vapiBindings_.BindingType {
...
func (eIface *effectiveDirectoryGroupMembersClient) List(nsGroupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.EffectiveMemberResourceListResult, error) {
	...
	sv := vapiBindings_.NewStructValueBuilder(effectiveDirectoryGroupMembersListInputType(), typeConverter)
