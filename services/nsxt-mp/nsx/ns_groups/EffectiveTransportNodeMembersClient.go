...
func NewEffectiveTransportNodeMembersClient(connector vapiProtocolClient_.Connector) *effectiveTransportNodeMembersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.ns_groups.effective_transport_node_members")
...
func (eIface *effectiveTransportNodeMembersClient) GetErrorBindingType(errorName string) vapiBindings_.BindingType {
...
func (eIface *effectiveTransportNodeMembersClient) List(nsGroupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.EffectiveMemberResourceListResult, error) {
	...
	sv := vapiBindings_.NewStructValueBuilder(effectiveTransportNodeMembersListInputType(), typeConverter)
