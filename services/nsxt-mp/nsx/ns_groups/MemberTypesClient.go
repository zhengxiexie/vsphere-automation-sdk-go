...
type MemberTypesClient interface {
	...
	Get(nsGroupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.EffectiveMemberTypeListResult, error)
}
...
func NewMemberTypesClient(connector vapiProtocolClient_.Connector) *memberTypesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.ns_groups.member_types")
...
func (mIface *memberTypesClient) Get(nsGroupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.EffectiveMemberTypeListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.EffectiveMemberTypeListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.EffectiveMemberTypeListResult), nil
	} else {
