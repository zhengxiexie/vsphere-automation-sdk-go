...
func serviceAssociationsListInputType() vapiBindings_.StructType {
	...
	fields["nsgroup_id"] = vapiBindings_.NewStringType()
	fields["service_type"] = vapiBindings_.NewStringType()
	fields["cursor"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	fields["fetch_parentgroup_associations"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
...
func ServiceAssociationsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.ServiceAssociationListResultBindingType)})
}

func serviceAssociationsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["nsgroup_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["sort_by"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	paramsTypeMap["fetch_parentgroup_associations"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
