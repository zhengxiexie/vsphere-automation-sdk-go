...
func effectiveVirtualMachineMembersListInputType() vapiBindings_.StructType {
...
func EffectiveVirtualMachineMembersListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.VirtualMachineListResultBindingType)
}

func effectiveVirtualMachineMembersListRestMetadata() vapiProtocol_.OperationRestMetadata {
