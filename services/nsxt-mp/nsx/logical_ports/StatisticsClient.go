...
type StatisticsClient interface {
	...
	Get(lportIdParam string, sourceParam *string) (nsxModel.LogicalPortStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.logical_ports.statistics")
...
func (sIface *statisticsClient) Get(lportIdParam string, sourceParam *string) (nsxModel.LogicalPortStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.LogicalPortStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.LogicalPortStatistics), nil
	} else {
