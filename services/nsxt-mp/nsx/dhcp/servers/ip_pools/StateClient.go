...
type StateClient interface {
	...
	Get(serverIdParam string, poolIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.ConfigurationState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.dhcp.servers.ip_pools.state")
...
func (sIface *stateClient) Get(serverIdParam string, poolIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.ConfigurationState, error) {
