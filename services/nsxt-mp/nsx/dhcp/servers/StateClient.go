...
type StateClient interface {
	...
	Get(serverIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.ConfigurationState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.dhcp.servers.state")
...
func (sIface *stateClient) Get(serverIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.ConfigurationState, error) {
