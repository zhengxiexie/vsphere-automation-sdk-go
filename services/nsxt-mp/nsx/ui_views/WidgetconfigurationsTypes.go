...
func widgetconfigurationsCreateInputType() vapiBindings_.StructType {
	...
	fields["widget_configuration"] = vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.WidgetConfigurationBindingType)})
...
func WidgetconfigurationsCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.WidgetConfigurationBindingType)})
}
...
func widgetconfigurationsCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["view_id"] = "ViewId"
	fieldNameMap["widget_configuration"] = "WidgetConfiguration"
	paramsTypeMap["widget_configuration"] = vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.WidgetConfigurationBindingType)})
...
func WidgetconfigurationsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.WidgetConfigurationListBindingType)
}
