...
func precheckCreateInputType() vapiBindings_.StructType {
...
func PrecheckCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.NvdsUpgradePrecheckIdBindingType)
}

func precheckCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
