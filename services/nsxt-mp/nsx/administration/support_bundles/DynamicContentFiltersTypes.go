...
func DynamicContentFiltersGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.DynamicContentFiltersBindingType)
}

func dynamicContentFiltersGetRestMetadata() vapiProtocol_.OperationRestMetadata {
