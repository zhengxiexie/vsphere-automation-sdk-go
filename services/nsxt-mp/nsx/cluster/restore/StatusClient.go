...
type StatusClient interface {
	...
	Get(restoreComponentParam *string) (nsxModel.ClusterRestoreStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.restore.status")
...
func (sIface *statusClient) Get(restoreComponentParam *string) (nsxModel.ClusterRestoreStatus, error) {
