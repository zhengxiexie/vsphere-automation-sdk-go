...
func roleBindingsCreateInputType() vapiBindings_.StructType {
	...
	fields["role_binding"] = vapiBindings_.NewReferenceType(nsxModel.RoleBindingBindingType)
...
func RoleBindingsCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.RoleBindingBindingType)
}
...
func roleBindingsCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["role_binding"] = vapiBindings_.NewReferenceType(nsxModel.RoleBindingBindingType)
	fieldNameMap["role_binding"] = "RoleBinding"
	paramsTypeMap["role_binding"] = vapiBindings_.NewReferenceType(nsxModel.RoleBindingBindingType)
...
func RoleBindingsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.RoleBindingListResultBindingType)
}
