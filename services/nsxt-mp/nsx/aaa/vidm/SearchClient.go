...
type SearchClient interface {
	...
	Create(searchStringParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.VidmInfoListResult, error)
}
...
func NewSearchClient(connector vapiProtocolClient_.Connector) *searchClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.aaa.vidm.search")
...
func (sIface *searchClient) Create(searchStringParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.VidmInfoListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.VidmInfoListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.VidmInfoListResult), nil
	} else {
