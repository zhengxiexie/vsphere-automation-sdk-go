...
type RetrieveClient interface {
	...
	Create(regTokenQueryParam nsxModel.RegTokenQuery) (nsxModel.RegistrationToken, error)
}
...
func NewRetrieveClient(connector vapiProtocolClient_.Connector) *retrieveClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.aaa.registration_token.retrieve")
...
func (rIface *retrieveClient) Create(regTokenQueryParam nsxModel.RegTokenQuery) (nsxModel.RegistrationToken, error) {
