...
type RoleAssignmentPermissionConfigClient interface {
	...
	Update(roleParam string, roleAssignmentPermissionConfigParam nsxModel.RoleAssignmentPermissionConfig) error
}
...
func NewRoleAssignmentPermissionConfigClient(connector vapiProtocolClient_.Connector) *roleAssignmentPermissionConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.aaa.roles.role_assignment_permission_config")
...
func (rIface *roleAssignmentPermissionConfigClient) Update(roleParam string, roleAssignmentPermissionConfigParam nsxModel.RoleAssignmentPermissionConfig) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.aaa.roles.role_assignment_permission_config", "update", inputDataValue, executionContext)
