...
type RolesWithFeaturePermissionsClient interface {
	...
	List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.RoleWithFeaturesListResult, error)
}
...
func NewRolesWithFeaturePermissionsClient(connector vapiProtocolClient_.Connector) *rolesWithFeaturePermissionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.aaa.roles_with_feature_permissions")
...
func (rIface *rolesWithFeaturePermissionsClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.RoleWithFeaturesListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.RoleWithFeaturesListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.RoleWithFeaturesListResult), nil
	} else {
