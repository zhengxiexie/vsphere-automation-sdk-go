...
func nodeUsageSummaryGetInputType() vapiBindings_.StructType {
...
func NodeUsageSummaryGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LbNodeUsageSummaryBindingType)
}

func nodeUsageSummaryGetRestMetadata() vapiProtocol_.OperationRestMetadata {
