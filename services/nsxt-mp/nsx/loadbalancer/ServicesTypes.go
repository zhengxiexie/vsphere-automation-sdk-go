...
func servicesCreateInputType() vapiBindings_.StructType {
	...
	fields["lb_service"] = vapiBindings_.NewReferenceType(nsxModel.LbServiceBindingType)
...
func ServicesCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LbServiceBindingType)
}
...
func servicesCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["lb_service"] = vapiBindings_.NewReferenceType(nsxModel.LbServiceBindingType)
	fieldNameMap["lb_service"] = "LbService"
	paramsTypeMap["lb_service"] = vapiBindings_.NewReferenceType(nsxModel.LbServiceBindingType)
...
func ServicesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LbServiceListResultBindingType)
}
