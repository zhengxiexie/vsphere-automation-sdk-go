...
type StatisticsClient interface {
	...
	Get(serviceIdParam string, sourceParam *string) (nsxModel.LbServiceStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.loadbalancer.services.statistics")
...
func (sIface *statisticsClient) Get(serviceIdParam string, sourceParam *string) (nsxModel.LbServiceStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.LbServiceStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.LbServiceStatistics), nil
	} else {
