...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LbVirtualServerStatusBindingType)
}
...
func StatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LbVirtualServerStatusListResultBindingType)
}
