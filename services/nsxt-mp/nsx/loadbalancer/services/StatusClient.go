...
type StatusClient interface {
	...
	Get(serviceIdParam string, includeInstanceDetailsParam *bool, sourceParam *string, transportNodeIdsParam *string) (nsxModel.LbServiceStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.loadbalancer.services.status")
...
func (sIface *statusClient) Get(serviceIdParam string, includeInstanceDetailsParam *bool, sourceParam *string, transportNodeIdsParam *string) (nsxModel.LbServiceStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.LbServiceStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.LbServiceStatus), nil
	} else {
