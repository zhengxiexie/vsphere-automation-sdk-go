...
func StateGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LogicalSwitchStateBindingType)
}
...
func StateListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LogicalSwitchStateListResultBindingType)
}
