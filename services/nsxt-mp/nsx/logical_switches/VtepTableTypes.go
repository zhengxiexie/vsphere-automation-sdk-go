...
func vtepTableListInputType() vapiBindings_.StructType {
...
func VtepTableListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.VtepListResultBindingType)
}

func vtepTableListRestMetadata() vapiProtocol_.OperationRestMetadata {
