...
type QueryClient interface {
	...
	List(queryParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.SearchResponse, error)
}
...
func NewQueryClient(connector vapiProtocolClient_.Connector) *queryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.search.query")
...
func (qIface *queryClient) List(queryParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.SearchResponse, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.SearchResponse
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.SearchResponse), nil
	} else {
