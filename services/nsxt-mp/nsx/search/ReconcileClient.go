...
func NewReconcileClient(connector vapiProtocolClient_.Connector) *reconcileClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.search.reconcile")
...
func (rIface *reconcileClient) Create(actionParam string, overrideParam *bool, scopeParam *string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.search.reconcile", "create", inputDataValue, executionContext)
