...
func ConfigGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.RealizationStateBarrierConfigBindingType)
}
...
func configUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["realization_state_barrier_config"] = vapiBindings_.NewReferenceType(nsxModel.RealizationStateBarrierConfigBindingType)
...
func configUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["realization_state_barrier_config"] = vapiBindings_.NewReferenceType(nsxModel.RealizationStateBarrierConfigBindingType)
	fieldNameMap["realization_state_barrier_config"] = "RealizationStateBarrierConfig"
	paramsTypeMap["realization_state_barrier_config"] = vapiBindings_.NewReferenceType(nsxModel.RealizationStateBarrierConfigBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
