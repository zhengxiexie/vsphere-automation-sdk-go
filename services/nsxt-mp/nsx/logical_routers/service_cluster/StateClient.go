...
type StateClient interface {
	...
	Get(logicalRouterIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.LogicalServiceRouterClusterState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.logical_routers.service_cluster.state")
...
func (sIface *stateClient) Get(logicalRouterIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.LogicalServiceRouterClusterState, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.LogicalServiceRouterClusterState
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.LogicalServiceRouterClusterState), nil
	} else {
