...
func BgpGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.BgpConfigBindingType)
}
...
func bgpUpdateInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["logical_router_id"] = vapiBindings_.NewStringType()
	fields["bgp_config"] = vapiBindings_.NewReferenceType(nsxModel.BgpConfigBindingType)
	fieldNameMap["logical_router_id"] = "LogicalRouterId"
...
func bgpUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["bgp_config"] = "BgpConfig"
	paramsTypeMap["logical_router_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["bgp_config"] = vapiBindings_.NewReferenceType(nsxModel.BgpConfigBindingType)
	paramsTypeMap["logicalRouterId"] = vapiBindings_.NewStringType()
	pathParams["logical_router_id"] = "logicalRouterId"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
