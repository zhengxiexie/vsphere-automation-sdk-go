...
func routeTableListInputType() vapiBindings_.StructType {
...
func RouteTableListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LogicalRouterRouteTableBindingType)
}

func routeTableListRestMetadata() vapiProtocol_.OperationRestMetadata {
