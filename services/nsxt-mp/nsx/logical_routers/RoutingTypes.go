...
func RoutingGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.RoutingConfigBindingType)
}
...
func routingUpdateInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["logical_router_id"] = vapiBindings_.NewStringType()
	fields["routing_config"] = vapiBindings_.NewReferenceType(nsxModel.RoutingConfigBindingType)
	fieldNameMap["logical_router_id"] = "LogicalRouterId"
...
func routingUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["routing_config"] = "RoutingConfig"
	paramsTypeMap["logical_router_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["routing_config"] = vapiBindings_.NewReferenceType(nsxModel.RoutingConfigBindingType)
	paramsTypeMap["logicalRouterId"] = vapiBindings_.NewStringType()
	pathParams["logical_router_id"] = "logicalRouterId"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
