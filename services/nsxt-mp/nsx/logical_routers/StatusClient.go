...
type StatusClient interface {
	...
	Get(logicalRouterIdParam string, sourceParam *string) (nsxModel.LogicalRouterStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.logical_routers.status")
...
func (sIface *statusClient) Get(logicalRouterIdParam string, sourceParam *string) (nsxModel.LogicalRouterStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.LogicalRouterStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.LogicalRouterStatus), nil
	} else {
