...
type SummaryClient interface {
	...
	Get(switchingProfileIdParam string) (nsxModel.SwitchingProfileStatus, error)
}
...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.switching_profiles.summary")
...
func (sIface *summaryClient) Get(switchingProfileIdParam string) (nsxModel.SwitchingProfileStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.SwitchingProfileStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.SwitchingProfileStatus), nil
	} else {
