...
func profilesCreateInputType() vapiBindings_.StructType {
	...
	fields["base_firewall_profile"] = vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.BaseFirewallProfileBindingType)})
...
func ProfilesCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.BaseFirewallProfileBindingType)})
}
...
func profilesCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["base_firewall_profile"] = vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.BaseFirewallProfileBindingType)})
	fieldNameMap["base_firewall_profile"] = "BaseFirewallProfile"
	paramsTypeMap["base_firewall_profile"] = vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.BaseFirewallProfileBindingType)})
...
func ProfilesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.FirewallProfileListResultBindingType)
}
