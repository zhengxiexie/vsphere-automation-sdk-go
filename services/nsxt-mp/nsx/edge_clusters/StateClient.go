...
type StateClient interface {
	...
	Get(edgeClusterIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.EdgeClusterState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.edge_clusters.state")
...
func (sIface *stateClient) Get(edgeClusterIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.EdgeClusterState, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.EdgeClusterState
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.EdgeClusterState), nil
	} else {
