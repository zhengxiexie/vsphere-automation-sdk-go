...
type StatusClient interface {
	...
	Get(edgeClusterIdParam string, sourceParam *string) (nsxModel.EdgeClusterStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.edge_clusters.status")
...
func (sIface *statusClient) Get(edgeClusterIdParam string, sourceParam *string) (nsxModel.EdgeClusterStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.EdgeClusterStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.EdgeClusterStatus), nil
	} else {
