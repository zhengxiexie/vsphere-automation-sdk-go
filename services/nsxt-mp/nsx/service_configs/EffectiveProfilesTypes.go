...
func effectiveProfilesListInputType() vapiBindings_.StructType {
...
func EffectiveProfilesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.EffectiveProfileListResultBindingType)
}

func effectiveProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
