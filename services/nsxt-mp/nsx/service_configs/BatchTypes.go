...
func batchCreateInputType() vapiBindings_.StructType {
	...
	fields["service_config_list"] = vapiBindings_.NewReferenceType(nsxModel.ServiceConfigListBindingType)
...
func batchCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["service_config_list"] = vapiBindings_.NewReferenceType(nsxModel.ServiceConfigListBindingType)
	fieldNameMap["service_config_list"] = "ServiceConfigList"
	paramsTypeMap["service_config_list"] = vapiBindings_.NewReferenceType(nsxModel.ServiceConfigListBindingType)
