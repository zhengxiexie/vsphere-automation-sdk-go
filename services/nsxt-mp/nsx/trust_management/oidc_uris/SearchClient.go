...
type SearchClient interface {
	...
	Create(idParam string, searchStringParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.ScimSearchListResult, error)
}
...
func NewSearchClient(connector vapiProtocolClient_.Connector) *searchClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.trust_management.oidc_uris.search")
...
func (sIface *searchClient) Create(idParam string, searchStringParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.ScimSearchListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.ScimSearchListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.ScimSearchListResult), nil
	} else {
