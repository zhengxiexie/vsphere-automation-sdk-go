...
func replaceHostCertificateCreateInputType() vapiBindings_.StructType {
...
func ReplaceHostCertificateCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func replaceHostCertificateCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
