...
type UsageClient interface {
	...
	Get(categoryParam *string, cursorParam *string, forceParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.CapacityUsageResponse, error)
}
...
func NewUsageClient(connector vapiProtocolClient_.Connector) *usageClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.capacity.usage")
...
func (uIface *usageClient) Get(categoryParam *string, cursorParam *string, forceParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.CapacityUsageResponse, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.CapacityUsageResponse
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.CapacityUsageResponse), nil
	} else {
