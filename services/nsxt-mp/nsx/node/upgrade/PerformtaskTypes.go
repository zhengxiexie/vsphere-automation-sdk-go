...
func performtaskCreateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["upgrade_task_properties"] = vapiBindings_.NewReferenceType(nsxModel.UpgradeTaskPropertiesBindingType)
...
func PerformtaskCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.UpgradeTaskPropertiesBindingType)
}

func performtaskCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["upgrade_task_properties"] = vapiBindings_.NewReferenceType(nsxModel.UpgradeTaskPropertiesBindingType)
