...
type StatsClient interface {
	...
	Get(interfaceIdParam string) (nsxModel.NodeInterfaceStatisticsProperties, error)
}
...
func NewStatsClient(connector vapiProtocolClient_.Connector) *statsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.node.network.interfaces.stats")
...
func (sIface *statsClient) Get(interfaceIdParam string) (nsxModel.NodeInterfaceStatisticsProperties, error) {
