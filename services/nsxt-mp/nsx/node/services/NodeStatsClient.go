...
func NewNodeStatsClient(connector vapiProtocolClient_.Connector) *nodeStatsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.node.services.node_stats")
...
func (nIface *nodeStatsClient) GetErrorBindingType(errorName string) vapiBindings_.BindingType {
...
func (nIface *nodeStatsClient) Get() (nsxModel.NodeServiceProperties, error) {
	...
	sv := vapiBindings_.NewStructValueBuilder(nodeStatsGetInputType(), typeConverter)
...
func (nIface *nodeStatsClient) Restart() (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	sv := vapiBindings_.NewStructValueBuilder(nodeStatsRestartInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
...
func (nIface *nodeStatsClient) Start() (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	sv := vapiBindings_.NewStructValueBuilder(nodeStatsStartInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsxModel.NodeServiceStatusProperties
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
...
func (nIface *nodeStatsClient) Stop() (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	sv := vapiBindings_.NewStructValueBuilder(nodeStatsStopInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsxModel.NodeServiceStatusProperties
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
