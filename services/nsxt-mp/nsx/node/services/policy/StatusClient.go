...
type StatusClient interface {
	...
	// GET https://<nsx-mgr>/api/v1/node/services/nsxt-mp/manager/status
	//
	...
	Get() (nsxModel.NodeServiceStatusProperties, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.node.services.policy.status")
...
func (sIface *statusClient) Get() (nsxModel.NodeServiceStatusProperties, error) {
