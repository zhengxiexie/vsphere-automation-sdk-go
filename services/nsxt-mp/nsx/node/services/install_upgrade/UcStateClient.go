...
type UcStateClient interface {
	...
	Update(ucStatePropertiesParam nsxModel.UcStateProperties) error
}
...
func NewUcStateClient(connector vapiProtocolClient_.Connector) *ucStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.node.services.install_upgrade.uc_state")
...
func (uIface *ucStateClient) Update(ucStatePropertiesParam nsxModel.UcStateProperties) error {
