...
func thumbprintGetInputType() vapiBindings_.StructType {
...
func ThumbprintGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.FileThumbprintBindingType)
}

func thumbprintGetRestMetadata() vapiProtocol_.OperationRestMetadata {
