...
func GlobalConfigGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.GlobalCollectionConfigurationBindingType)
}
...
func globalConfigUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["global_collection_configuration"] = vapiBindings_.NewReferenceType(nsxModel.GlobalCollectionConfigurationBindingType)
...
func globalConfigUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["global_collection_configuration"] = vapiBindings_.NewReferenceType(nsxModel.GlobalCollectionConfigurationBindingType)
	fieldNameMap["global_collection_configuration"] = "GlobalCollectionConfiguration"
	paramsTypeMap["global_collection_configuration"] = vapiBindings_.NewReferenceType(nsxModel.GlobalCollectionConfigurationBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
