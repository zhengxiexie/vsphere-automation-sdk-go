...
func StatsGetallOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LogicalConstructMigrationStatsListResultBindingType)
}

func statsGetallRestMetadata() vapiProtocol_.OperationRestMetadata {
