...
func feedbackListInputType() vapiBindings_.StructType {
	...
	fields["mp_display_name"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	fields["mp_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
...
func FeedbackListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.FeedBackListResultBindingType)
}

func feedbackListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["mp_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	paramsTypeMap["mp_display_name"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
