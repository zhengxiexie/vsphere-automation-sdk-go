...
func discoveredSwitchesListInputType() vapiBindings_.StructType {
...
func DiscoveredSwitchesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.MigrationSwitchListResultBindingType)
}

func discoveredSwitchesListRestMetadata() vapiProtocol_.OperationRestMetadata {
