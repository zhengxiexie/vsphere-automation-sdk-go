...
type AggregateInfoClient interface {
	...
	List(componentTypeParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, summaryParam *bool, syncParam *bool) (nsxModel.MigrationUnitGroupAggregateInfoListResult, error)
}
...
func NewAggregateInfoClient(connector vapiProtocolClient_.Connector) *aggregateInfoClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.migration.migration_unit_groups.aggregate_info")
...
func (aIface *aggregateInfoClient) List(componentTypeParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, summaryParam *bool, syncParam *bool) (nsxModel.MigrationUnitGroupAggregateInfoListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.MigrationUnitGroupAggregateInfoListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.MigrationUnitGroupAggregateInfoListResult), nil
	} else {
