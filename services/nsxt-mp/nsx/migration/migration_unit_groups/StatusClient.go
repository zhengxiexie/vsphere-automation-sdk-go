...
type StatusClient interface {
	...
	List(groupIdParam string, cursorParam *string, hasErrorsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.MigrationUnitStatusListResult, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.migration.migration_unit_groups.status")
...
func (sIface *statusClient) List(groupIdParam string, cursorParam *string, hasErrorsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsxModel.MigrationUnitStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.MigrationUnitStatusListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.MigrationUnitStatusListResult), nil
	} else {
