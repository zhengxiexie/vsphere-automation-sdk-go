...
func GroupedFeedbackRequestsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.GroupedMigrationFeedbackRequestListResultBindingType)
}

func groupedFeedbackRequestsListRestMetadata() vapiProtocol_.OperationRestMetadata {
