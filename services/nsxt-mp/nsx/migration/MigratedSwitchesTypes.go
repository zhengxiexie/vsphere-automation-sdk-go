...
func migratedSwitchesListInputType() vapiBindings_.StructType {
...
func MigratedSwitchesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.MigrationSwitchListResultBindingType)
}

func migratedSwitchesListRestMetadata() vapiProtocol_.OperationRestMetadata {
