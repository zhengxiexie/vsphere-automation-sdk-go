...
// Data type definitions file for service: BridgeClusters.
...
func bridgeClustersGetInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["vcenter_id"] = vapiBindings_.NewStringType()
	fields["vlan_id"] = vapiBindings_.NewStringType()
...
func BridgeClustersGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.RecommendationListResultBindingType)
}

func bridgeClustersGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["vlan_id"] = "VlanId"
	fieldNameMap["project_id"] = "ProjectId"
	paramsTypeMap["vlan_id"] = vapiBindings_.NewStringType()
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/migration/overlay-adoption/vcenters/{vcenterId}/recommendation/bridge-clusters",
		"",
		resultHeaders,
		200,
		"",
