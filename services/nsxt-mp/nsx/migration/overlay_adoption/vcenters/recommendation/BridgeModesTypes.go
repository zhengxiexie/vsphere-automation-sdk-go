...
// Data type definitions file for service: BridgeModes.
...
func bridgeModesGetInputType() vapiBindings_.StructType {
...
func BridgeModesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.RecommendationListResultBindingType)
}

func bridgeModesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/migration/overlay-adoption/vcenters/{vcenterId}/recommendation/bridge-modes",
		"",
		resultHeaders,
		200,
		"",
