...
func resetCreateInputType() vapiBindings_.StructType {
...
func ResetCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func resetCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"POST",
		"/api/v1/migration/overlay-adoption/vcenters/{vcenterId}/workflow/action/reset",
		"",
		resultHeaders,
		204,
		"",
