...
func SearchCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewDynamicStructType([]vapiBindings_.ReferenceType{vapiBindings_.NewReferenceType(nsxModel.WorkflowSpecBindingType)})
}
...
func searchCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"POST",
		"/api/v1/migration/overlay-adoption/vcenters/{vcenterId}/workflow/spec/search",
		"",
		resultHeaders,
		201,
		"",
