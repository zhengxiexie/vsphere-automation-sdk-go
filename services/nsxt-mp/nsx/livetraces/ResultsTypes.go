...
func resultsGetInputType() vapiBindings_.StructType {
	...
	fields["action_type"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
...
func ResultsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.LiveTraceResultBindingType)
}

func resultsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["action_type"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
