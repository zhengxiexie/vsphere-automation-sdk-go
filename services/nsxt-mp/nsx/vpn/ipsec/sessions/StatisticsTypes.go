...
func StatisticsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.IPSecVPNSessionStatisticsBindingType)
}
...
func statisticsResetInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["session_id"] = vapiBindings_.NewStringType()
	fieldNameMap["session_id"] = "SessionId"
...
func StatisticsResetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func statisticsResetRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
