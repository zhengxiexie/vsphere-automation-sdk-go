...
func capabilitiesGetInputType() vapiBindings_.StructType {
...
func CapabilitiesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.NodeCapabilitiesResultBindingType)
}

func capabilitiesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
