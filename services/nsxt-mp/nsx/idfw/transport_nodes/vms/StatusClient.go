...
type StatusClient interface {
	...
	List(transportNodeIdParam string) (nsxModel.IdfwVirtualMachineStatusListResult, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.idfw.transport_nodes.vms.status")
...
func (sIface *statusClient) List(transportNodeIdParam string) (nsxModel.IdfwVirtualMachineStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.IdfwVirtualMachineStatusListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.IdfwVirtualMachineStatusListResult), nil
	} else {
