...
func availableReleasesListInputType() vapiBindings_.StructType {
...
func AvailableReleasesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.NSXReleasesBindingType)
}

func availableReleasesListRestMetadata() vapiProtocol_.OperationRestMetadata {
