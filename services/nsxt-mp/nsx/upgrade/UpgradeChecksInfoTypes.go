...
func upgradeChecksInfoListInputType() vapiBindings_.StructType {
...
func UpgradeChecksInfoListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ComponentUpgradeChecksInfoListResultBindingType)
}

func upgradeChecksInfoListRestMetadata() vapiProtocol_.OperationRestMetadata {
