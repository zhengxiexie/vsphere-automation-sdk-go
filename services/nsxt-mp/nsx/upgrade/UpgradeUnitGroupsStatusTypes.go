...
func upgradeUnitGroupsStatusGetallInputType() vapiBindings_.StructType {
...
func UpgradeUnitGroupsStatusGetallOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.UpgradeUnitGroupStatusListResultBindingType)
}

func upgradeUnitGroupsStatusGetallRestMetadata() vapiProtocol_.OperationRestMetadata {
