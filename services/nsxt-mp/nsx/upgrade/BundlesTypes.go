...
func bundlesCreateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["upgrade_bundle_fetch_request"] = vapiBindings_.NewReferenceType(nsxModel.UpgradeBundleFetchRequestBindingType)
	fields["install"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	fieldNameMap["upgrade_bundle_fetch_request"] = "UpgradeBundleFetchRequest"
	fieldNameMap["install"] = "Install"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}

func BundlesCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.UpgradeBundleIdBindingType)
}
...
func bundlesCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["upgrade_bundle_fetch_request"] = "UpgradeBundleFetchRequest"
	fieldNameMap["install"] = "Install"
	paramsTypeMap["upgrade_bundle_fetch_request"] = vapiBindings_.NewReferenceType(nsxModel.UpgradeBundleFetchRequestBindingType)
	paramsTypeMap["install"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	queryParams["install"] = "install"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
...
func BundlesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.UpgradeBundleInfoBindingType)
}
