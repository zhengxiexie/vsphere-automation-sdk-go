...
// Data type definitions file for service: FilterUnits.
...
func filterUnitsListInputType() vapiBindings_.StructType {
	...
	fields["hypervisor"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	fieldNameMap["hypervisor"] = "Hypervisor"
...
func FilterUnitsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.UpgradeUnitAggregateInfoListResultBindingType)
}

func filterUnitsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["hypervisor"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	queryParams["hypervisor"] = "hypervisor"
