...
type StateClient interface {
	...
	Get(forwarderIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.ConfigurationState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.dns.forwarders.state")
...
func (sIface *stateClient) Get(forwarderIdParam string, barrierIdParam *int64, requestIdParam *string) (nsxModel.ConfigurationState, error) {
