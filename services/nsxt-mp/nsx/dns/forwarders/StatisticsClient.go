...
type StatisticsClient interface {
	...
	Get(forwarderIdParam string) (nsxModel.DnsForwarderStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.dns.forwarders.statistics")
...
func (sIface *statisticsClient) Get(forwarderIdParam string) (nsxModel.DnsForwarderStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.DnsForwarderStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.DnsForwarderStatistics), nil
	} else {
