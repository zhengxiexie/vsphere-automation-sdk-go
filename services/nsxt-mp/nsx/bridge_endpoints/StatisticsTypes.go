...
func statisticsGetInputType() vapiBindings_.StructType {
	...
	fields["endpoint_id"] = vapiBindings_.NewStringType()
...
func StatisticsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.BridgeEndpointStatisticsBindingType)
}
...
func statisticsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["endpoint_id"] = "EndpointId"
	fieldNameMap["source"] = "Source"
	paramsTypeMap["endpoint_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["source"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	paramsTypeMap["endpointId"] = vapiBindings_.NewStringType()
