...
type StatisticsClient interface {
	...
	Get(endpointIdParam string, sourceParam *string) (nsxModel.BridgeEndpointStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.bridge_endpoints.statistics")
...
func (sIface *statisticsClient) Get(endpointIdParam string, sourceParam *string) (nsxModel.BridgeEndpointStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.BridgeEndpointStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.BridgeEndpointStatistics), nil
	} else {
