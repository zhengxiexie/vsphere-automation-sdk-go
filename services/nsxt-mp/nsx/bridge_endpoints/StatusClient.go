...
type StatusClient interface {
	...
	Get(endpointIdParam string, sourceParam *string) (nsxModel.BridgeEndpointStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.bridge_endpoints.status")
...
func (sIface *statusClient) Get(endpointIdParam string, sourceParam *string) (nsxModel.BridgeEndpointStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.BridgeEndpointStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.BridgeEndpointStatus), nil
	} else {
