...
// Data type definitions file for service: DeploymentIddisableFederatedLogin.
...
func deploymentIddisableFederatedLoginDisableFederatedLoginInputType() vapiBindings_.StructType {
...
func DeploymentIddisableFederatedLoginDisableFederatedLoginOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_aws_providerModel.ActivityResponseBindingType)
}

func deploymentIddisableFederatedLoginDisableFederatedLoginRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/inventory/{orgId}/vmc-aws/deployments/{deploymentId}:disable-federated-login",
		"",
		resultHeaders,
		200,
		"",
