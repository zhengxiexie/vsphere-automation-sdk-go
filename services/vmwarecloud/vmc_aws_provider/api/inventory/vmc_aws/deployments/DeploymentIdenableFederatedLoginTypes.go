...
// Data type definitions file for service: DeploymentIdenableFederatedLogin.
...
func deploymentIdenableFederatedLoginEnableFederatedLoginInputType() vapiBindings_.StructType {
...
func DeploymentIdenableFederatedLoginEnableFederatedLoginOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_aws_providerModel.ActivityResponseBindingType)
}

func deploymentIdenableFederatedLoginEnableFederatedLoginRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/inventory/{orgId}/vmc-aws/deployments/{deploymentId}:enable-federated-login",
		"",
		resultHeaders,
		200,
		"",
