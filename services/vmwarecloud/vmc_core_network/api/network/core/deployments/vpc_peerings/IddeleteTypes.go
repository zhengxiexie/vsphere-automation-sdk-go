...
// Data type definitions file for service: Iddelete.
...
func iddeleteDeleteVpcPeeringInputType() vapiBindings_.StructType {
...
func IddeleteDeleteVpcPeeringOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.ActivityBindingType)
}

func iddeleteDeleteVpcPeeringRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/network/{orgId}/core/deployments/{deploymentId}/vpc-peerings/{id}:delete",
		"",
		resultHeaders,
		200,
		"",
