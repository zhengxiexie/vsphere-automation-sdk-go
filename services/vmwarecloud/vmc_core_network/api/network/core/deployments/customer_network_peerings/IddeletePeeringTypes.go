...
// Data type definitions file for service: IddeletePeering.
...
func iddeletePeeringDeleteCustomerPeeringNetworkInputType() vapiBindings_.StructType {
...
func IddeletePeeringDeleteCustomerPeeringNetworkOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.NetworkActivityBindingType)
}

func iddeletePeeringDeleteCustomerPeeringNetworkRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/network/{orgId}/core/deployments/{deploymentId}/customer-network-peerings/{id}:delete-peering",
		"",
		resultHeaders,
		200,
		"",
