...
// Data type definitions file for service: VmList.
...
func vmListGetNsxVmListInputType() vapiBindings_.StructType {
...
func VmListGetNsxVmListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.NsxVmListBindingType)
}

func vmListGetNsxVmListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/network/{orgId}/core/deployments/{deploymentId}/nsx/vm-list",
		"",
		resultHeaders,
		200,
		"",
