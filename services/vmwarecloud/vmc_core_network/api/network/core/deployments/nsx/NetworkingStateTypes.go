...
// Data type definitions file for service: NetworkingState.
...
func networkingStateGetSddcNetworkingStateByDeploymentIdInputType() vapiBindings_.StructType {
...
func NetworkingStateGetSddcNetworkingStateByDeploymentIdOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.DeploymentNetworkingStateInfoBindingType)
}

func networkingStateGetSddcNetworkingStateByDeploymentIdRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/network/{orgId}/core/deployments/{deploymentId}/nsx/networking-state",
		"",
		resultHeaders,
		200,
		"",
