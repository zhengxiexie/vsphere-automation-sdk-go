...
func iddeleteIpDeletePublicIpInputType() vapiBindings_.StructType {
...
func IddeleteIpDeletePublicIpOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.NetworkActivityBindingType)
}

func iddeleteIpDeletePublicIpRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/network/{orgId}/core/deployments/{deploymentId}/ips/{id}:delete-ip",
		"",
		resultHeaders,
		200,
		"",
