...
// Data type definitions file for service: Nsx.
...
func nsxGetNsxDetailsForDeploymentInputType() vapiBindings_.StructType {
...
func NsxGetNsxDetailsForDeploymentOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.NsxDetailsBindingType)
}

func nsxGetNsxDetailsForDeploymentRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/network/{orgId}/core/deployments/{deploymentId}/nsx",
		"",
		resultHeaders,
		200,
		"",
