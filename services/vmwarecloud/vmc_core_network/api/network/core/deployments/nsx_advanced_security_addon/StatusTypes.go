...
func statusGetNsxAdvancedSecurityAddonStatusInputType() vapiBindings_.StructType {
...
func StatusGetNsxAdvancedSecurityAddonStatusOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.NsxAddonResponseBindingType)
}

func statusGetNsxAdvancedSecurityAddonStatusRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/network/{orgId}/core/deployments/{deploymentId}/nsx-advanced-security-addon/status",
		"",
		resultHeaders,
		200,
		"",
