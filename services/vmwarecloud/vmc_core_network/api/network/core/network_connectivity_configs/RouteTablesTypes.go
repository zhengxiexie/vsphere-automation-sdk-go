...
// Data type definitions file for service: RouteTables.
...
func routeTablesGetRouteTablesForNetworkConnectivityConfigInputType() vapiBindings_.StructType {
...
func RouteTablesGetRouteTablesForNetworkConnectivityConfigOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.RouteTableResponseBindingType)
}

func routeTablesGetRouteTablesForNetworkConnectivityConfigRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/network/{orgId}/core/network-connectivity-configs/{id}/route-tables",
		"",
		resultHeaders,
		200,
		"",
...
func routeTablesGetAssociatedRouteTableByIdInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["id"] = vapiBindings_.NewStringType()
...
func RouteTablesGetAssociatedRouteTableByIdOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.RouteTableBindingType)
}

func routeTablesGetAssociatedRouteTableByIdRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/network/{orgId}/core/network-connectivity-configs/{id}/route-tables/{routeTableId}",
		"",
		resultHeaders,
		200,
		"",
