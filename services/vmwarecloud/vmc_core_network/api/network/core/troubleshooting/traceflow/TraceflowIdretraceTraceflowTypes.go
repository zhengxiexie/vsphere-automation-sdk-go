...
// Data type definitions file for service: TraceflowIdretraceTraceflow.
...
func traceflowIdretraceTraceflowRetraceSddcTraceflowActivityInputType() vapiBindings_.StructType {
...
func TraceflowIdretraceTraceflowRetraceSddcTraceflowActivityOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_networkModel.ActivityBindingType)
}

func traceflowIdretraceTraceflowRetraceSddcTraceflowActivityRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/network/{orgId}/core/troubleshooting/traceflow/{traceflowId}:retrace-traceflow",
		"",
		resultHeaders,
		200,
		"",
