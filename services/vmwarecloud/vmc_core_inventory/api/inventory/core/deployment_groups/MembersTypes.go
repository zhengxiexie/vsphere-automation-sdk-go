...
func membersGetCoreDeploymentGroupMembersInputType() vapiBindings_.StructType {
...
func MembersGetCoreDeploymentGroupMembersOutputType() vapiBindings_.BindingType {
...
func membersGetCoreDeploymentGroupMembersRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/inventory/{orgId}/core/deployment-groups/{deploymentGroupId}/members",
		"",
		resultHeaders,
		200,
		"",
