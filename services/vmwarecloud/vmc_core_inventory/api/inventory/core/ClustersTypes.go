...
func clustersGetCoreClustersInputType() vapiBindings_.StructType {
...
func ClustersGetCoreClustersOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_inventoryModel.ClusterResponseBindingType)
}

func clustersGetCoreClustersRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/inventory/{orgId}/core/clusters",
		"",
		resultHeaders,
		200,
		"",
...
func clustersGetCoreClusterByIdInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
...
func ClustersGetCoreClusterByIdOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmwarecloudVmc_core_inventoryModel.ClusterBindingType)
}

func clustersGetCoreClusterByIdRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/inventory/{orgId}/core/clusters/{clusterId}",
		"",
		resultHeaders,
		200,
		"",
