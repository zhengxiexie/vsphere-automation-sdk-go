...
func SiteRecoveryVersionsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcDraasModel.SiteRecoveryVersionsBindingType)
}

func siteRecoveryVersionsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
