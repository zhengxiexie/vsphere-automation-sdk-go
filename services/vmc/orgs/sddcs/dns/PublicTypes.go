...
func publicUpdateInputType() vapiBindings_.StructType {
...
func PublicUpdateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcModel.TaskBindingType)
}

func publicUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
