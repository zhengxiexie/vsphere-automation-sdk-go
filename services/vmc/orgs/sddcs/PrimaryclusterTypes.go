...
func primaryclusterGetInputType() vapiBindings_.StructType {
...
func PrimaryclusterGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcModel.ClusterBindingType)
}

func primaryclusterGetRestMetadata() vapiProtocol_.OperationRestMetadata {
