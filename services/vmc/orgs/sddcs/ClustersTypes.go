...
func clustersCreateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org"] = vapiBindings_.NewStringType()
	fields["sddc"] = vapiBindings_.NewStringType()
	fields["cluster_config"] = vapiBindings_.NewReferenceType(vmcModel.ClusterConfigBindingType)
...
func ClustersCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcModel.TaskBindingType)
}

func clustersCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["sddc"] = "Sddc"
	fieldNameMap["cluster_config"] = "ClusterConfig"
	paramsTypeMap["cluster_config"] = vapiBindings_.NewReferenceType(vmcModel.ClusterConfigBindingType)
...
func clustersDeleteInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org"] = vapiBindings_.NewStringType()
	fields["sddc"] = vapiBindings_.NewStringType()
...
func ClustersDeleteOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcModel.TaskBindingType)
}

func clustersDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
