...
func sddcTemplateGetInputType() vapiBindings_.StructType {
...
func SddcTemplateGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcModel.SddcTemplateBindingType)
}

func sddcTemplateGetRestMetadata() vapiProtocol_.OperationRestMetadata {
