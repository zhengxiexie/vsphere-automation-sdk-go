...
func productsListInputType() vapiBindings_.StructType {
...
func ProductsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewListType(vapiBindings_.NewReferenceType(vmcModel.SubscriptionProductsBindingType), reflect.TypeOf([]vmcModel.SubscriptionProducts{}))
}

func productsListRestMetadata() vapiProtocol_.OperationRestMetadata {
