...
func inputsGetInputType() vapiBindings_.StructType {
...
func InputsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(vmcModel.SddcInputBindingType)
}

func inputsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
