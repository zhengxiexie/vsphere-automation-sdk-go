...
type ResourcesClient interface {
	...
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.ResourceInfoListResult, error)
}
...
func NewResourcesClient(connector vapiProtocolClient_.Connector) *resourcesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.fine_tuning.resources")
...
func (rIface *resourcesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.ResourceInfoListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ResourceInfoListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ResourceInfoListResult), nil
	} else {
