...
type InstructionResourcesClient interface {
	...
	Get(instructionIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ActionableResourceListResult, error)
}
...
func NewInstructionResourcesClient(connector vapiProtocolClient_.Connector) *instructionResourcesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.cluster.restore.instruction_resources")
...
func (iIface *instructionResourcesClient) Get(instructionIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ActionableResourceListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ActionableResourceListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ActionableResourceListResult), nil
	} else {
