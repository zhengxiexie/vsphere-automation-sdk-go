...
type OverviewClient interface {
	...
	List(cursorParam *string, frameTypeParam *string, includedFieldsParam *string, pageSizeParam *int64, showBackupsListParam *bool, siteIdParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.BackupOverview, error)
}
...
func NewOverviewClient(connector vapiProtocolClient_.Connector) *overviewClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.cluster.backups.overview")
...
func (oIface *overviewClient) List(cursorParam *string, frameTypeParam *string, includedFieldsParam *string, pageSizeParam *int64, showBackupsListParam *bool, siteIdParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.BackupOverview, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.BackupOverview
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.BackupOverview), nil
	} else {
