...
func ConfigGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.BackupConfigurationBindingType)
}
...
func configUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["backup_configuration"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.BackupConfigurationBindingType)
...
func configUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["backup_configuration"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.BackupConfigurationBindingType)
