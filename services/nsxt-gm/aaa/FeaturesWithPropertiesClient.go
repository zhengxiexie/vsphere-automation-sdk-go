...
type FeaturesWithPropertiesClient interface {
	...
	List() (nsx_global_policyModel.FeaturePermissionListResult, error)
}
...
func NewFeaturesWithPropertiesClient(connector vapiProtocolClient_.Connector) *featuresWithPropertiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.aaa.features_with_properties")
...
func (fIface *featuresWithPropertiesClient) List() (nsx_global_policyModel.FeaturePermissionListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.FeaturePermissionListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.FeaturePermissionListResult), nil
	} else {
