...
type SearchClient interface {
	...
	Create(ldapIdentitySourceIdParam string, filterValueParam string) (nsx_global_policyModel.LdapIdentitySourceSearchResultList, error)
}
...
func NewSearchClient(connector vapiProtocolClient_.Connector) *searchClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.aaa.ldap_identity_sources.search")
...
func (sIface *searchClient) Create(ldapIdentitySourceIdParam string, filterValueParam string) (nsx_global_policyModel.LdapIdentitySourceSearchResultList, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.LdapIdentitySourceSearchResultList
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.LdapIdentitySourceSearchResultList), nil
	} else {
