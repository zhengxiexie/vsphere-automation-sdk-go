...
func roleAssignmentPermissionConfigUpdateInputType() vapiBindings_.StructType {
	...
	fields["role_assignment_permission_config"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.RoleAssignmentPermissionConfigBindingType)
...
func roleAssignmentPermissionConfigUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["role_assignment_permission_config"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.RoleAssignmentPermissionConfigBindingType)
	paramsTypeMap["role"] = vapiBindings_.NewStringType()
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"PUT",
		"/global-manager/api/v1/aaa/roles/{role}/role-assignment-permission-config",
		"",
		resultHeaders,
		204,
		"",
