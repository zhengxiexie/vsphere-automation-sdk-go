...
type UserInfoClient interface {
	...
	Get(provideFlatListingParam *bool, rootPathParam *string) (nsx_global_policyModel.UserInfo, error)
}
...
func NewUserInfoClient(connector vapiProtocolClient_.Connector) *userInfoClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.aaa.user_info")
...
func (uIface *userInfoClient) Get(provideFlatListingParam *bool, rootPathParam *string) (nsx_global_policyModel.UserInfo, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.UserInfo
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.UserInfo), nil
	} else {
