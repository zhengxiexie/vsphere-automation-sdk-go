...
type RegistrationTokenClient interface {
	...
	Create() (nsx_global_policyModel.RegistrationToken, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tokenParam string) (nsx_global_policyModel.RegistrationToken, error)
}
...
func NewRegistrationTokenClient(connector vapiProtocolClient_.Connector) *registrationTokenClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.aaa.registration_token")
...
func (rIface *registrationTokenClient) Create() (nsx_global_policyModel.RegistrationToken, error) {
...
func (rIface *registrationTokenClient) Get(tokenParam string) (nsx_global_policyModel.RegistrationToken, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
