...
func ManagementGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ManagementConfigBindingType)
}
...
func managementUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["management_config"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ManagementConfigBindingType)
...
func managementUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["management_config"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ManagementConfigBindingType)
	fieldNameMap["management_config"] = "ManagementConfig"
	paramsTypeMap["management_config"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ManagementConfigBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
