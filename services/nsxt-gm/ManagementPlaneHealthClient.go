...
func NewManagementPlaneHealthClient(connector vapiProtocolClient_.Connector) *managementPlaneHealthClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.management_plane_health")
...
func (mIface *managementPlaneHealthClient) Get() (*vapiData_.StructValue, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.management_plane_health", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
