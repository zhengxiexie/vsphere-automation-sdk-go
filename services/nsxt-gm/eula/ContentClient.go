...
type ContentClient interface {
	...
	Get(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, valueFormatParam *string) (nsx_global_policyModel.EULAContent, error)
}
...
func NewContentClient(connector vapiProtocolClient_.Connector) *contentClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.eula.content")
...
func (cIface *contentClient) Get(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, valueFormatParam *string) (nsx_global_policyModel.EULAContent, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.EULAContent
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.EULAContent), nil
	} else {
