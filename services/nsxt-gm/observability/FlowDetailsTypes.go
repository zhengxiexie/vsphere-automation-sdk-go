...
func flowDetailsGetInputType() vapiBindings_.StructType {
...
func FlowDetailsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.MonitoringInfoBindingType)
}

func flowDetailsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
