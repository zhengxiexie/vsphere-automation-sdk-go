...
type StateClient interface {
	...
	Get(segmentIdParam string, portIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_global_policyModel.SegmentPortState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.segments.ports.state")
...
func (sIface *stateClient) Get(segmentIdParam string, portIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_global_policyModel.SegmentPortState, error) {
