...
type SummaryClient interface {
	...
	Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_global_policyModel.PolicyInterfaceStatisticsSummary, error)
}
...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_statistics.summary")
...
func (sIface *summaryClient) Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_global_policyModel.PolicyInterfaceStatisticsSummary, error) {
