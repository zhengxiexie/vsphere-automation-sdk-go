...
type ExportClient interface {
	...
	Cancel() (nsx_global_policyModel.ExportTask, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Create(exportRequestParameterParam nsx_global_policyModel.ExportRequestParameter) (nsx_global_policyModel.ExportTask, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get() (nsx_global_policyModel.ExportTask, error)
}
...
func NewExportClient(connector vapiProtocolClient_.Connector) *exportClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.settings.firewall.export")
...
func (eIface *exportClient) Cancel() (nsx_global_policyModel.ExportTask, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ExportTask
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ExportTask), nil
	} else {
...
func (eIface *exportClient) Create(exportRequestParameterParam nsx_global_policyModel.ExportRequestParameter) (nsx_global_policyModel.ExportTask, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
...
func (eIface *exportClient) Get() (nsx_global_policyModel.ExportTask, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
