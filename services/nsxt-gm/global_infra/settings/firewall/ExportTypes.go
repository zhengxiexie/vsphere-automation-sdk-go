...
func ExportCancelOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ExportTaskBindingType)
}
...
func exportCreateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["export_request_parameter"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ExportRequestParameterBindingType)
...
func exportCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["export_request_parameter"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ExportRequestParameterBindingType)
	fieldNameMap["export_request_parameter"] = "ExportRequestParameter"
	paramsTypeMap["export_request_parameter"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ExportRequestParameterBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
