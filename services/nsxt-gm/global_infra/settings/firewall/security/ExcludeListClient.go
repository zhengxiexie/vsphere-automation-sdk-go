...
type ExcludeListClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.PolicyResourceReference
	//
	...
	Filter(intentPathParam string, deepCheckParam *bool, enforcementPointPathParam *string) (nsx_global_policyModel.PolicyResourceReference, error)

	// Read exclude list for firewall
	// @return com.vmware.nsx_global_policy.model.PolicyExcludeList
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get() (nsx_global_policyModel.PolicyExcludeList, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get0() (nsx_global_policyModel.PolicyExcludeList, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(policyExcludeListParam nsx_global_policyModel.PolicyExcludeList) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(policyExcludeListParam nsx_global_policyModel.PolicyExcludeList) (nsx_global_policyModel.PolicyExcludeList, error)
}
...
func NewExcludeListClient(connector vapiProtocolClient_.Connector) *excludeListClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.settings.firewall.security.exclude_list")
...
func (eIface *excludeListClient) Filter(intentPathParam string, deepCheckParam *bool, enforcementPointPathParam *string) (nsx_global_policyModel.PolicyResourceReference, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyResourceReference
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.settings.firewall.security.exclude_list", "filter", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyResourceReference
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyResourceReference), nil
	} else {
...
func (eIface *excludeListClient) Get() (nsx_global_policyModel.PolicyExcludeList, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyExcludeList
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.settings.firewall.security.exclude_list", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyExcludeList
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyExcludeList), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (eIface *excludeListClient) Get0() (nsx_global_policyModel.PolicyExcludeList, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.settings.firewall.security.exclude_list", "get_0", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyExcludeList
	if methodResult.IsSuccess() {
...
func (eIface *excludeListClient) Patch(policyExcludeListParam nsx_global_policyModel.PolicyExcludeList) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.settings.firewall.security.exclude_list", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (eIface *excludeListClient) Update(policyExcludeListParam nsx_global_policyModel.PolicyExcludeList) (nsx_global_policyModel.PolicyExcludeList, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.settings.firewall.security.exclude_list", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyExcludeList
	if methodResult.IsSuccess() {
