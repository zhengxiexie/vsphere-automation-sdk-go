...
func NewPoliciesClient(connector vapiProtocolClient_.Connector) *policiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.firewall.policies")
...
func (pIface *policiesClient) List(scopeParam string, enforcementPointPathParam *string, parentPathParam *string) (nsx_global_policyModel.PolicyResourceReferenceForEPListResult, error) {
