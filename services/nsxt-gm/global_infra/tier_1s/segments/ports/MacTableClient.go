...
type MacTableClient interface {
	...
	List(tier1IdParam string, segmentIdParam string, portIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_global_policyModel.SegmentPortMacAddressListResult, error)
}
...
func NewMacTableClient(connector vapiProtocolClient_.Connector) *macTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.ports.mac_table")
