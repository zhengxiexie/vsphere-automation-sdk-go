...
type StatisticsClient interface {
	...
	Get(tier1IdParam string, segmentsIdParam string, portIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_global_policyModel.SegmentPortStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.ports.statistics")
...
func (sIface *statisticsClient) Get(tier1IdParam string, segmentsIdParam string, portIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_global_policyModel.SegmentPortStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.SegmentPortStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.SegmentPortStatistics), nil
	} else {
