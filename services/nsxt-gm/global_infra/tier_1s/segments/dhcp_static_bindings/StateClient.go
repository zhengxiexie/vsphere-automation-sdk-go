...
type StateClient interface {
	...
	Get(tier1IdParam string, segmentIdParam string, bindingIdParam string) (nsx_global_policyModel.DhcpStaticBindingState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.dhcp_static_bindings.state")
...
func (sIface *stateClient) Get(tier1IdParam string, segmentIdParam string, bindingIdParam string) (nsx_global_policyModel.DhcpStaticBindingState, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.DhcpStaticBindingState
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.DhcpStaticBindingState), nil
	} else {
