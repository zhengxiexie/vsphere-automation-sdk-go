...
type StatisticsClient interface {
	...
	List(tier1IdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_global_policyModel.PolicyNatRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.nat.nat_rules.statistics")
...
func (sIface *statisticsClient) List(tier1IdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_global_policyModel.PolicyNatRuleStatisticsListResult, error) {
