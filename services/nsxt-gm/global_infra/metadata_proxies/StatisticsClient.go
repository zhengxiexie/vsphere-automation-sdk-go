...
type StatisticsClient interface {
	...
	Get(metadataProxyIdParam string, enforcementPointPathParam *string, segmentPathParam *string, sourceParam *string) (nsx_global_policyModel.PolicyMetadataProxyStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.metadata_proxies.statistics")
...
func (sIface *statisticsClient) Get(metadataProxyIdParam string, enforcementPointPathParam *string, segmentPathParam *string, sourceParam *string) (nsx_global_policyModel.PolicyMetadataProxyStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyMetadataProxyStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyMetadataProxyStatistics), nil
	} else {
