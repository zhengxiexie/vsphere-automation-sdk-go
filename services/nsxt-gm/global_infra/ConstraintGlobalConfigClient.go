...
type ConstraintGlobalConfigClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.ConstraintGlobalConfig
	//
	...
	Get() (nsx_global_policyModel.ConstraintGlobalConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(constraintGlobalConfigParam nsx_global_policyModel.ConstraintGlobalConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(constraintGlobalConfigParam nsx_global_policyModel.ConstraintGlobalConfig) (nsx_global_policyModel.ConstraintGlobalConfig, error)
}
...
func NewConstraintGlobalConfigClient(connector vapiProtocolClient_.Connector) *constraintGlobalConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.constraint_global_config")
...
func (cIface *constraintGlobalConfigClient) Get() (nsx_global_policyModel.ConstraintGlobalConfig, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ConstraintGlobalConfig
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.constraint_global_config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ConstraintGlobalConfig
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ConstraintGlobalConfig), nil
	} else {
...
func (cIface *constraintGlobalConfigClient) Patch(constraintGlobalConfigParam nsx_global_policyModel.ConstraintGlobalConfig) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.constraint_global_config", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *constraintGlobalConfigClient) Update(constraintGlobalConfigParam nsx_global_policyModel.ConstraintGlobalConfig) (nsx_global_policyModel.ConstraintGlobalConfig, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.constraint_global_config", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ConstraintGlobalConfig
	if methodResult.IsSuccess() {
