...
type StatisticsClient interface {
	...
	List(domainIdParam string, gatewayPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_global_policyModel.RuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.gateway_policies.rules.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, gatewayPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_global_policyModel.RuleStatisticsListResult, error) {
