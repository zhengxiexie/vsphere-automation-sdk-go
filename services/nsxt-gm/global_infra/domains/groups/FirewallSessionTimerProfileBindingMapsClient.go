...
type FirewallSessionTimerProfileBindingMapsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(domainIdParam string, groupIdParam string, firewallSessionTimerProfileBindingMapIdParam string) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(domainIdParam string, groupIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(domainIdParam string, groupIdParam string, firewallSessionTimerProfileBindingMapIdParam string, policyFirewallSessionTimerProfileBindingMapParam nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(domainIdParam string, groupIdParam string, firewallSessionTimerProfileBindingMapIdParam string, policyFirewallSessionTimerProfileBindingMapParam nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap, error)
}
...
func NewFirewallSessionTimerProfileBindingMapsClient(connector vapiProtocolClient_.Connector) *firewallSessionTimerProfileBindingMapsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.firewall_session_timer_profile_binding_maps")
...
func (fIface *firewallSessionTimerProfileBindingMapsClient) Get(domainIdParam string, groupIdParam string, firewallSessionTimerProfileBindingMapIdParam string) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (fIface *firewallSessionTimerProfileBindingMapsClient) List(domainIdParam string, groupIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResult, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
...
func (fIface *firewallSessionTimerProfileBindingMapsClient) Patch(domainIdParam string, groupIdParam string, firewallSessionTimerProfileBindingMapIdParam string, policyFirewallSessionTimerProfileBindingMapParam nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMap) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
