...
type MacAddressExpressionsClient interface {
	...
	Create(domainIdParam string, groupIdParam string, expressionIdParam string, mACAddressListParam nsx_global_policyModel.MACAddressList, actionParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(domainIdParam string, groupIdParam string, expressionIdParam string, mACAddressExpressionParam nsx_global_policyModel.MACAddressExpression) error
}
...
func NewMacAddressExpressionsClient(connector vapiProtocolClient_.Connector) *macAddressExpressionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.mac_address_expressions")
...
func (mIface *macAddressExpressionsClient) GetErrorBindingType(errorName string) vapiBindings_.BindingType {
...
func (mIface *macAddressExpressionsClient) Create(domainIdParam string, groupIdParam string, expressionIdParam string, mACAddressListParam nsx_global_policyModel.MACAddressList, actionParam string) error {
	...
	sv := vapiBindings_.NewStructValueBuilder(macAddressExpressionsCreateInputType(), typeConverter)
...
func (mIface *macAddressExpressionsClient) Patch(domainIdParam string, groupIdParam string, expressionIdParam string, mACAddressExpressionParam nsx_global_policyModel.MACAddressExpression) error {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
