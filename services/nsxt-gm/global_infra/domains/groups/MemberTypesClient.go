...
type MemberTypesClient interface {
	...
	Get(domainIdParam string, groupIdParam string) (nsx_global_policyModel.GroupMemberTypeListResult, error)
}
...
func NewMemberTypesClient(connector vapiProtocolClient_.Connector) *memberTypesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.member_types")
...
func (mIface *memberTypesClient) Get(domainIdParam string, groupIdParam string) (nsx_global_policyModel.GroupMemberTypeListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.GroupMemberTypeListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.GroupMemberTypeListResult), nil
	} else {
