...
type PathExpressionsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(domainIdParam string, groupIdParam string, expressionIdParam string, pathExpressionParam nsx_global_policyModel.PathExpression) error
}
...
func NewPathExpressionsClient(connector vapiProtocolClient_.Connector) *pathExpressionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.path_expressions")
...
func (pIface *pathExpressionsClient) Create(domainIdParam string, groupIdParam string, expressionIdParam string, groupMemberListParam nsx_global_policyModel.GroupMemberList, actionParam string) error {
...
func (pIface *pathExpressionsClient) Patch(domainIdParam string, groupIdParam string, expressionIdParam string, pathExpressionParam nsx_global_policyModel.PathExpression) error {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
