...
func podsListInputType() vapiBindings_.StructType {
...
func PodsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyContainerGroupMembersListResultBindingType)
}

func podsListRestMetadata() vapiProtocol_.OperationRestMetadata {
