...
func consolidatedEffectiveIpAddressesListInputType() vapiBindings_.StructType {
...
func ConsolidatedEffectiveIpAddressesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ConsolidatedEffectiveIPAddressMemberListResultBindingType)
}

func consolidatedEffectiveIpAddressesListRestMetadata() vapiProtocol_.OperationRestMetadata {
