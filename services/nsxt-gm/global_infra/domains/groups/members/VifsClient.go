...
type VifsClient interface {
	...
	List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.VirtualNetworkInterfaceListResult, error)
}
...
func NewVifsClient(connector vapiProtocolClient_.Connector) *vifsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.members.vifs")
...
func (vIface *vifsClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.VirtualNetworkInterfaceListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.VirtualNetworkInterfaceListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.VirtualNetworkInterfaceListResult), nil
	} else {
