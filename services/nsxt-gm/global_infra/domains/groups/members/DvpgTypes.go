...
func dvpgListInputType() vapiBindings_.StructType {
...
func DvpgListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyGroupMembersListResultBindingType)
}

func dvpgListRestMetadata() vapiProtocol_.OperationRestMetadata {
