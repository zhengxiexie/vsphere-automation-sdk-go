...
func NewCloudNativeServiceInstancesClient(connector vapiProtocolClient_.Connector) *cloudNativeServiceInstancesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.members.cloud_native_service_instances")
...
func (cIface *cloudNativeServiceInstancesClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyGroupMembersListResult, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.domains.groups.members.cloud_native_service_instances", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyGroupMembersListResult
