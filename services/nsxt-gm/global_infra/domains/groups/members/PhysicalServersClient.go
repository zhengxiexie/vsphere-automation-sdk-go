...
func NewPhysicalServersClient(connector vapiProtocolClient_.Connector) *physicalServersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.groups.members.physical_servers")
...
func (pIface *physicalServersClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyGroupMembersListResult, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.domains.groups.members.physical_servers", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyGroupMembersListResult
