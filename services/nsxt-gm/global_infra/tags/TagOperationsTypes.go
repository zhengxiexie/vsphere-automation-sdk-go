...
func TagOperationsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.TagBulkOperationBindingType)
}
...
func tagOperationsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tags/tag-operations/{operationId}",
		"",
		resultHeaders,
		200,
		"",
...
func tagOperationsUpdateInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["operation_id"] = vapiBindings_.NewStringType()
	fields["tag_bulk_operation"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TagBulkOperationBindingType)
	fields["cursor"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	fields["enforcement_point_path"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	fields["include_mark_for_delete_objects"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	fields["included_fields"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
...
func tagOperationsUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["sort_by"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	paramsTypeMap["include_mark_for_delete_objects"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	paramsTypeMap["tag_bulk_operation"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TagBulkOperationBindingType)
	paramsTypeMap["page_size"] = vapiBindings_.NewOptionalType(vapiBindings_.NewIntegerType())
	paramsTypeMap["operationId"] = vapiBindings_.NewStringType()
	pathParams["operation_id"] = "operationId"
	queryParams["cursor"] = "cursor"
