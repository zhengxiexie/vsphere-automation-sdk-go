...
type TagOperationsClient interface {
	...
	Get(operationIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.TagBulkOperation, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(operationIdParam string, tagBulkOperationParam nsx_global_policyModel.TagBulkOperation, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.TagBulkOperation, error)
}
...
func NewTagOperationsClient(connector vapiProtocolClient_.Connector) *tagOperationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tags.tag_operations")
...
func (tIface *tagOperationsClient) Get(operationIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.TagBulkOperation, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TagBulkOperation
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tags.tag_operations", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TagBulkOperation
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TagBulkOperation), nil
	} else {
...
func (tIface *tagOperationsClient) Update(operationIdParam string, tagBulkOperationParam nsx_global_policyModel.TagBulkOperation, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.TagBulkOperation, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tags.tag_operations", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TagBulkOperation
	if methodResult.IsSuccess() {
