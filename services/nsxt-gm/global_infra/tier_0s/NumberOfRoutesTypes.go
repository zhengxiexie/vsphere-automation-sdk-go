...
func NumberOfRoutesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.Tier0NumberOfRoutesResultBindingType)
}
...
func numberOfRoutesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/number-of-routes",
		"",
		resultHeaders,
		200,
		"",
