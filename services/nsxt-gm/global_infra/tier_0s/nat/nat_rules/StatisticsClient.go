...
type StatisticsClient interface {
	...
	List(tier0IdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_global_policyModel.PolicyNatRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.nat.nat_rules.statistics")
...
func (sIface *statisticsClient) List(tier0IdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_global_policyModel.PolicyNatRuleStatisticsListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyNatRuleStatisticsListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyNatRuleStatisticsListResult), nil
	} else {
