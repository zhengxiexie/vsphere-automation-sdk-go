...
type DadStateClient interface {
	...
	Get(tier0IdParam string, localeServiceIdParam string, interfaceIdParam string, enforcementPointPathParam *string) (nsx_global_policyModel.InterfaceDADState, error)
}
...
func NewDadStateClient(connector vapiProtocolClient_.Connector) *dadStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.interfaces.dad_state")
...
func (dIface *dadStateClient) Get(tier0IdParam string, localeServiceIdParam string, interfaceIdParam string, enforcementPointPathParam *string) (nsx_global_policyModel.InterfaceDADState, error) {
