...
type StatusClient interface {
	...
	List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_global_policyModel.PolicyBgpNeighborsStatusListResult, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.bgp.neighbors.status")
...
func (sIface *statusClient) List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_global_policyModel.PolicyBgpNeighborsStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyBgpNeighborsStatusListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyBgpNeighborsStatusListResult), nil
	} else {
