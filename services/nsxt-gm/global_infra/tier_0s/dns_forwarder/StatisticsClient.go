...
type StatisticsClient interface {
	...
	Get(tier0IdParam string, enforcementPointPathParam *string) (nsx_global_policyModel.AggregateDNSForwarderStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder.statistics")
...
func (sIface *statisticsClient) Get(tier0IdParam string, enforcementPointPathParam *string) (nsx_global_policyModel.AggregateDNSForwarderStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.AggregateDNSForwarderStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.AggregateDNSForwarderStatistics), nil
	} else {
