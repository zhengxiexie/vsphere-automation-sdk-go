...
type EnforcementPointsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(siteIdParam string, enforcementpointIdParam string) (nsx_global_policyModel.EnforcementPoint, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(siteIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.EnforcementPointListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(siteIdParam string, enforcementpointIdParam string, enforcementPointParam nsx_global_policyModel.EnforcementPoint) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Reload(siteIdParam string, enforcementpointIdParam string) (nsx_global_policyModel.EnforcementPoint, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(siteIdParam string, enforcementpointIdParam string, enforcementPointParam nsx_global_policyModel.EnforcementPoint) (nsx_global_policyModel.EnforcementPoint, error)
}
...
func NewEnforcementPointsClient(connector vapiProtocolClient_.Connector) *enforcementPointsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.sites.enforcement_points")
...
func (eIface *enforcementPointsClient) Get(siteIdParam string, enforcementpointIdParam string) (nsx_global_policyModel.EnforcementPoint, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
...
func (eIface *enforcementPointsClient) List(siteIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.EnforcementPointListResult, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.EnforcementPointListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.EnforcementPointListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (eIface *enforcementPointsClient) Patch(siteIdParam string, enforcementpointIdParam string, enforcementPointParam nsx_global_policyModel.EnforcementPoint) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
...
func (eIface *enforcementPointsClient) Reload(siteIdParam string, enforcementpointIdParam string) (nsx_global_policyModel.EnforcementPoint, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
...
func (eIface *enforcementPointsClient) Update(siteIdParam string, enforcementpointIdParam string, enforcementPointParam nsx_global_policyModel.EnforcementPoint) (nsx_global_policyModel.EnforcementPoint, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
