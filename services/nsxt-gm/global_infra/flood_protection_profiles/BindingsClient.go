...
type BindingsClient interface {
	...
	List(floodProtectionProfileIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.FloodProtectionProfileBindingListResult, error)
}
...
func NewBindingsClient(connector vapiProtocolClient_.Connector) *bindingsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.flood_protection_profiles.bindings")
...
func (bIface *bindingsClient) List(floodProtectionProfileIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.FloodProtectionProfileBindingListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.FloodProtectionProfileBindingListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.FloodProtectionProfileBindingListResult), nil
	} else {
