...
type StatusClient interface {
	...
	Get() (nsx_policyModel.PolicyComplianceStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.compliance.status")
...
func (sIface *statusClient) Get() (nsx_policyModel.PolicyComplianceStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.PolicyComplianceStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.PolicyComplianceStatus), nil
	} else {
