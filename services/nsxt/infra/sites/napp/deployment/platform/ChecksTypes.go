...
func checksUpdateInputType() vapiBindings_.StructType {
	...
	fields["platform_deployment_checks_action"] = vapiBindings_.NewReferenceType(nsx_policyModel.PlatformDeploymentChecksActionBindingType)
...
func checksUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["platform_deployment_checks_action"] = vapiBindings_.NewReferenceType(nsx_policyModel.PlatformDeploymentChecksActionBindingType)
