...
// Data type definitions file for service: EnterMaintenanceMode.
...
func enterMaintenanceModeCreateInputType() vapiBindings_.StructType {
...
func EnterMaintenanceModeCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func enterMaintenanceModeCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-transport-nodes/{edgeTransportNodeId}/action/enter-maintenance-mode",
		"",
		resultHeaders,
		204,
		"",
