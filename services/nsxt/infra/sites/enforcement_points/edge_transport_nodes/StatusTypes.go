...
// Possible value for ``status`` of method Status#list.
const Status_LIST_STATUS_UP = "UP"

// Possible value for ``status`` of method Status#list.
const Status_LIST_STATUS_DOWN = "DOWN"

// Possible value for ``status`` of method Status#list.
const Status_LIST_STATUS_DEGRADED = "DEGRADED"

// Possible value for ``status`` of method Status#list.
const Status_LIST_STATUS_UNKNOWN = "UNKNOWN"
...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransportNodeStatusBindingType)
}
...
func statusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-transport-nodes/{edgeTransportNodeId}/status",
		"",
		resultHeaders,
		200,
		"",
...
func statusListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-transport-nodes/status",
		"",
		resultHeaders,
		200,
		"",
