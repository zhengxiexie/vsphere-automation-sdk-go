...
type StatusClient interface {
	...
	Get(siteIdParam string, enforcementpointIdParam string, clusterControlPlaneIdParam string) (nsx_policyModel.AntreaClusterInfo, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.cluster_control_planes.status")
...
func (sIface *statusClient) Get(siteIdParam string, enforcementpointIdParam string, clusterControlPlaneIdParam string) (nsx_policyModel.AntreaClusterInfo, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.AntreaClusterInfo
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.AntreaClusterInfo), nil
	} else {
