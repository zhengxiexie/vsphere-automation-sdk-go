...
func FailureDomainsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyFailureDomainBindingType)
}
...
func FailureDomainsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyFailureDomainListResultBindingType)
}
...
func failureDomainsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/failure-domains",
		"",
		resultHeaders,
		200,
		"",
...
func failureDomainsPatchInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["site_id"] = vapiBindings_.NewStringType()
	fields["enforcementpoint_id"] = vapiBindings_.NewStringType()
	fields["failure_domain_id"] = vapiBindings_.NewStringType()
	fields["policy_failure_domain"] = vapiBindings_.NewReferenceType(nsx_policyModel.PolicyFailureDomainBindingType)
	fieldNameMap["site_id"] = "SiteId"
	fieldNameMap["enforcementpoint_id"] = "EnforcementpointId"
	fieldNameMap["failure_domain_id"] = "FailureDomainId"
	fieldNameMap["policy_failure_domain"] = "PolicyFailureDomain"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}

func FailureDomainsPatchOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func failureDomainsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	paramsTypeMap["site_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["policy_failure_domain"] = vapiBindings_.NewReferenceType(nsx_policyModel.PolicyFailureDomainBindingType)
	paramsTypeMap["siteId"] = vapiBindings_.NewStringType()
	paramsTypeMap["enforcementpointId"] = vapiBindings_.NewStringType()
