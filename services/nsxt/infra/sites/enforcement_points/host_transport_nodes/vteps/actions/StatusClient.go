...
type StatusClient interface {
	...
	List(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (nsx_policyModel.TransportNodeVtepActionsStatusListResult, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.host_transport_nodes.vteps.actions.status")
...
func (sIface *statusClient) List(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (nsx_policyModel.TransportNodeVtepActionsStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.TransportNodeVtepActionsStatusListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.TransportNodeVtepActionsStatusListResult), nil
	} else {
