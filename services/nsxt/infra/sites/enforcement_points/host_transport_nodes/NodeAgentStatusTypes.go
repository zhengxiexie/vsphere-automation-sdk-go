...
func nodeAgentStatusListInputType() vapiBindings_.StructType {
...
func NodeAgentStatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TnNodeAgentStatusListResultBindingType)
}

func nodeAgentStatusListRestMetadata() vapiProtocol_.OperationRestMetadata {
