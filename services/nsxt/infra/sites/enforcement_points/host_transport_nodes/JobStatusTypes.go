...
// Data type definitions file for service: JobStatus.
...
// Possible value for ``errorCode`` of method JobStatus#list.
const JobStatus_LIST_ERROR_CODE_SUCCESS = "SUCCESS"

// Possible value for ``errorCode`` of method JobStatus#list.
const JobStatus_LIST_ERROR_CODE_FAILED = "FAILED"

// Possible value for ``status`` of method JobStatus#list.
const JobStatus_LIST_STATUS_PENDING = "PENDING"

// Possible value for ``status`` of method JobStatus#list.
const JobStatus_LIST_STATUS_IN_PROGRESS = "IN_PROGRESS"

// Possible value for ``status`` of method JobStatus#list.
const JobStatus_LIST_STATUS_SUCCESS = "SUCCESS"

// Possible value for ``status`` of method JobStatus#list.
const JobStatus_LIST_STATUS_PARTIAL_SUCCESS = "PARTIAL_SUCCESS"

// Possible value for ``status`` of method JobStatus#list.
const JobStatus_LIST_STATUS_FAILED = "FAILED"

// Possible value for ``status`` of method JobStatus#list.
const JobStatus_LIST_STATUS_ORPHANED = "ORPHANED"

func jobStatusListInputType() vapiBindings_.StructType {
...
func JobStatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.HostTransportNodeJobStatusListResultBindingType)
}

func jobStatusListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/host-transport-nodes/{hostTransportNodeId}/job-status",
		"",
		resultHeaders,
		200,
		"",
