...
// Data type definitions file for service: Debug.
...
func debugGetInputType() vapiBindings_.StructType {
...
func DebugGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ObservabilityCounterDebugQueryResultBindingType)
}

func debugGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/host-transport-nodes/{hostTransportNodeId}/statistics/debug",
		"",
		resultHeaders,
		200,
		"",
