...
// Data type definitions file for service: Monitor.
...
func monitorGetInputType() vapiBindings_.StructType {
...
func MonitorGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ObservabilityCounterMonitorQueryResultBindingType)
}

func monitorGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/host-transport-nodes/{hostTransportNodeId}/statistics/monitor",
		"",
		resultHeaders,
		200,
		"",
