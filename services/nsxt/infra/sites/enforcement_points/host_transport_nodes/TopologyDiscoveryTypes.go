...
func topologyDiscoveryGetInputType() vapiBindings_.StructType {
...
func TopologyDiscoveryGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.NodeInterfaceNeighborPropertiesBindingType)
}

func topologyDiscoveryGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/host-transport-nodes/{nodeId}/topology-discovery",
		"",
		resultHeaders,
		200,
		"",
