...
func hyperbusStatusGetInputType() vapiBindings_.StructType {
...
func HyperbusStatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TnHyperbusStatusBindingType)
}

func hyperbusStatusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
