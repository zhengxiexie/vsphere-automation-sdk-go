...
func TunnelsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TunnelPropertiesBindingType)
}
...
func TunnelsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TunnelListBindingType)
}
