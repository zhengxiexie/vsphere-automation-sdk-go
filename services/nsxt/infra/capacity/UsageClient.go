...
type UsageClient interface {
	...
	Get(categoryParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyCapacityUsageResponse, error)
}
...
func NewUsageClient(connector vapiProtocolClient_.Connector) *usageClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.capacity.usage")
...
func (uIface *usageClient) Get(categoryParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyCapacityUsageResponse, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.PolicyCapacityUsageResponse
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.PolicyCapacityUsageResponse), nil
	} else {
