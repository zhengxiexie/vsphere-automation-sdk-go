...
func igmpMembershipsListInputType() vapiBindings_.StructType {
...
func IgmpMembershipsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.IgmpMembershipsBindingType)
}

func igmpMembershipsListRestMetadata() vapiProtocol_.OperationRestMetadata {
