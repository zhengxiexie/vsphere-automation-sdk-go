...
func StateGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.OdsDynamicRunbookInstanceStateBindingType)
}
...
func stateGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sha/dynamic-runbook-instances/{instanceId}/state",
		"",
		resultHeaders,
		200,
		"",
