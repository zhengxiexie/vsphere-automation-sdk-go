...
type StatusClient interface {
	...
	Get(traceflowIdParam string, enforcementPointPathParam *string) (nsx_policyModel.AntreaTraceflowStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.antrea.traceflows.status")
...
func (sIface *statusClient) Get(traceflowIdParam string, enforcementPointPathParam *string) (nsx_policyModel.AntreaTraceflowStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.AntreaTraceflowStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.AntreaTraceflowStatus), nil
	} else {
