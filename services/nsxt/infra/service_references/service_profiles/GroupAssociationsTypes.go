...
func groupAssociationsGetInputType() vapiBindings_.StructType {
...
func GroupAssociationsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ServiceProfileGroupsBindingType)
}

func groupAssociationsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
