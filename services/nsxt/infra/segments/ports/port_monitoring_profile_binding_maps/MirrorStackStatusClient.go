...
type MirrorStackStatusClient interface {
	...
	List(infraSegmentIdParam string, infraPortIdParam string, portMonitoringProfileBindingMapIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.MirrorStackStatusListResult, error)
}
...
func NewMirrorStackStatusClient(connector vapiProtocolClient_.Connector) *mirrorStackStatusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.segments.ports.port_monitoring_profile_binding_maps.mirror_stack_status")
...
func (mIface *mirrorStackStatusClient) List(infraSegmentIdParam string, infraPortIdParam string, portMonitoringProfileBindingMapIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.MirrorStackStatusListResult, error) {
