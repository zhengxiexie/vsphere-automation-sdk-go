...
type ImportK8sNpToDfwClient interface {
	...
	Create(networkPolicyImportRequestParam nsx_policyModel.NetworkPolicyImportRequest, onErrorParam *string) (nsx_policyModel.NetworkPolicyImportResponse, error)
}
...
func NewImportK8sNpToDfwClient(connector vapiProtocolClient_.Connector) *importK8sNpToDfwClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.import_k8s_np_to_dfw")
...
func (iIface *importK8sNpToDfwClient) Create(networkPolicyImportRequestParam nsx_policyModel.NetworkPolicyImportRequest, onErrorParam *string) (nsx_policyModel.NetworkPolicyImportResponse, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.import_k8s_np_to_dfw", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.NetworkPolicyImportResponse
