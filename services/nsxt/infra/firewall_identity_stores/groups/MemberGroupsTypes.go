...
func memberGroupsListInputType() vapiBindings_.StructType {
...
func MemberGroupsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DirectoryGroupMemberListResultsBindingType)
}

func memberGroupsListRestMetadata() vapiProtocol_.OperationRestMetadata {
