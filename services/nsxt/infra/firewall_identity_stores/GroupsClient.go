...
type GroupsClient interface {
	...
	List(firewallIdentityStoreIdParam string, filterValueParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DirectoryGroupListResults, error)
}
...
func NewGroupsClient(connector vapiProtocolClient_.Connector) *groupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.firewall_identity_stores.groups")
...
func (gIface *groupsClient) List(firewallIdentityStoreIdParam string, filterValueParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DirectoryGroupListResults, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.DirectoryGroupListResults
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.DirectoryGroupListResults), nil
	} else {
