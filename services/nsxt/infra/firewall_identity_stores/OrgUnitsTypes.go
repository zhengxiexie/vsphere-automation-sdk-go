...
func orgUnitsListInputType() vapiBindings_.StructType {
...
func OrgUnitsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DirectoryOrgUnitListResultsBindingType)
}

func orgUnitsListRestMetadata() vapiProtocol_.OperationRestMetadata {
