...
type ParentGroupsClient interface {
	...
	List(identityFirewallStoreIdParam string, groupIdParam string) (nsx_policyModel.IdentityFirewallStoreUserOrGrouptListResults, error)
}
...
func NewParentGroupsClient(connector vapiProtocolClient_.Connector) *parentGroupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.identity_firewall_stores.groups.parent_groups")
...
func (pIface *parentGroupsClient) List(identityFirewallStoreIdParam string, groupIdParam string) (nsx_policyModel.IdentityFirewallStoreUserOrGrouptListResults, error) {
