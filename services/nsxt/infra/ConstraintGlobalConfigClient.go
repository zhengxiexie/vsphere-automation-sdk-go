...
func NewConstraintGlobalConfigClient(connector vapiProtocolClient_.Connector) *constraintGlobalConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.constraint_global_config")
...
func (cIface *constraintGlobalConfigClient) Get() (nsx_policyModel.ConstraintGlobalConfig, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.constraint_global_config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ConstraintGlobalConfig
...
func (cIface *constraintGlobalConfigClient) Patch(constraintGlobalConfigParam nsx_policyModel.ConstraintGlobalConfig) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.constraint_global_config", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *constraintGlobalConfigClient) Update(constraintGlobalConfigParam nsx_policyModel.ConstraintGlobalConfig) (nsx_policyModel.ConstraintGlobalConfig, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.constraint_global_config", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ConstraintGlobalConfig
	if methodResult.IsSuccess() {
