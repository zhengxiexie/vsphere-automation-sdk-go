...
type StatisticsClient interface {
	...
	Get(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.AggregateL3VpnStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.l3vpns.statistics")
...
func (sIface *statisticsClient) Get(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.AggregateL3VpnStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.AggregateL3VpnStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.AggregateL3VpnStatistics), nil
	} else {
