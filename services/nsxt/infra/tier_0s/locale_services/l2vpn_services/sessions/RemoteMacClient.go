...
func NewRemoteMacClient(connector vapiProtocolClient_.Connector) *remoteMacClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.l2vpn_services.sessions.remote_mac")
...
func (rIface *remoteMacClient) Get(tier0IdParam string, localeServiceIdParam string, serviceIdParam string, sessionIdParam string, enforcementPointPathParam *string, segmentPathParam *string) (nsx_policyModel.AggregateL2VpnSessionRemoteMac, error) {
