...
type StatisticsClient interface {
	...
	Get(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.AggregateL2VpnStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.l2vpn_context.l2vpns.statistics")
...
func (sIface *statisticsClient) Get(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.AggregateL2VpnStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.AggregateL2VpnStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.AggregateL2VpnStatistics), nil
	} else {
