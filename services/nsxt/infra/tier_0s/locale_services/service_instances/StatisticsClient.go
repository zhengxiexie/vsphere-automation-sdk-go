...
type StatisticsClient interface {
	...
	Get(tier0IdParam string, localeServiceIdParam string, serviceInstanceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.PolicyServiceInstanceStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.service_instances.statistics")
...
func (sIface *statisticsClient) Get(tier0IdParam string, localeServiceIdParam string, serviceInstanceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.PolicyServiceInstanceStatistics, error) {
