...
type IgmpMembershipsClient interface {
	...
	List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IgmpMemberships, error)
}
...
func NewIgmpMembershipsClient(connector vapiProtocolClient_.Connector) *igmpMembershipsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.multicast.igmp_memberships")
...
func (iIface *igmpMembershipsClient) List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IgmpMemberships, error) {
