...
func forwardingListInputType() vapiBindings_.StructType {
...
func ForwardingListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyMulticastForwardingBindingType)
}

func forwardingListRestMetadata() vapiProtocol_.OperationRestMetadata {
