...
func pimRpMappingsListInputType() vapiBindings_.StructType {
...
func PimRpMappingsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PimRpMappingsBindingType)
}

func pimRpMappingsListRestMetadata() vapiProtocol_.OperationRestMetadata {
