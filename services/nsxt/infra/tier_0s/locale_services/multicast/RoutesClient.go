...
type RoutesClient interface {
	...
	List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyMulticastRoutes, error)
}
...
func NewRoutesClient(connector vapiProtocolClient_.Connector) *routesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.multicast.routes")
...
func (rIface *routesClient) List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyMulticastRoutes, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.PolicyMulticastRoutes
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.PolicyMulticastRoutes), nil
	} else {
