...
func antreaIpPoolsListInputType() vapiBindings_.StructType {
...
func AntreaIpPoolsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupAntreaIPPoolListResultBindingType)
}

func antreaIpPoolsListRestMetadata() vapiProtocol_.OperationRestMetadata {
