...
func antreaEgressesListInputType() vapiBindings_.StructType {
...
func AntreaEgressesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupAntreaEgressListResultBindingType)
}

func antreaEgressesListRestMetadata() vapiProtocol_.OperationRestMetadata {
