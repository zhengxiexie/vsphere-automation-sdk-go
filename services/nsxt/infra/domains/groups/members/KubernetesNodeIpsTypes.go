...
func kubernetesNodeIpsListInputType() vapiBindings_.StructType {
...
func KubernetesNodeIpsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupKubernetesNodeListResultBindingType)
}

func kubernetesNodeIpsListRestMetadata() vapiProtocol_.OperationRestMetadata {
