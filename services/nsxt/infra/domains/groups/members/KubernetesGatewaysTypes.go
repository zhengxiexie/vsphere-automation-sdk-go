...
func kubernetesGatewaysListInputType() vapiBindings_.StructType {
...
func KubernetesGatewaysListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupKubernetesGatewayListResultBindingType)
}

func kubernetesGatewaysListRestMetadata() vapiProtocol_.OperationRestMetadata {
