...
func kubernetesServicesListInputType() vapiBindings_.StructType {
...
func KubernetesServicesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupKubernetesServiceListResultBindingType)
}

func kubernetesServicesListRestMetadata() vapiProtocol_.OperationRestMetadata {
