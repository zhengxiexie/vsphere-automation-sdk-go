...
func kubernetesNodePodCidrsListInputType() vapiBindings_.StructType {
...
func KubernetesNodePodCidrsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupPodCidrListResultBindingType)
}

func kubernetesNodePodCidrsListRestMetadata() vapiProtocol_.OperationRestMetadata {
