...
type KubernetesNodeIpsClient interface {
	...
	List(domainIdParam string, groupIdParam string, clusterIdParam *string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyGroupKubernetesNodeListResult, error)
}
...
func NewKubernetesNodeIpsClient(connector vapiProtocolClient_.Connector) *kubernetesNodeIpsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.groups.members.kubernetes_node_ips")
...
func (kIface *kubernetesNodeIpsClient) GetErrorBindingType(errorName string) vapiBindings_.BindingType {
...
func (kIface *kubernetesNodeIpsClient) List(domainIdParam string, groupIdParam string, clusterIdParam *string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyGroupKubernetesNodeListResult, error) {
	...
	sv := vapiBindings_.NewStructValueBuilder(kubernetesNodeIpsListInputType(), typeConverter)
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.PolicyGroupKubernetesNodeListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.PolicyGroupKubernetesNodeListResult), nil
	} else {
