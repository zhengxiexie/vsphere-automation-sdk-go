...
func kubernetesIngressesListInputType() vapiBindings_.StructType {
...
func KubernetesIngressesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupKubernetesIngressListResultBindingType)
}

func kubernetesIngressesListRestMetadata() vapiProtocol_.OperationRestMetadata {
