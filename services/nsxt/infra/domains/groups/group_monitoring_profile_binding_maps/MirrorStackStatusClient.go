...
type MirrorStackStatusClient interface {
	...
	List(domainIdParam string, groupIdParam string, groupMonitoringProfileBindingMapIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.MirrorStackStatusListResult, error)
}
...
func NewMirrorStackStatusClient(connector vapiProtocolClient_.Connector) *mirrorStackStatusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.groups.group_monitoring_profile_binding_maps.mirror_stack_status")
...
func (mIface *mirrorStackStatusClient) List(domainIdParam string, groupIdParam string, groupMonitoringProfileBindingMapIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.MirrorStackStatusListResult, error) {
