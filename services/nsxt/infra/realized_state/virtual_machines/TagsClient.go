...
type TagsClient interface {
	...
	Create(virtualMachineIdParam string, virtualMachineTagsUpdateParam nsx_policyModel.VirtualMachineTagsUpdate, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.realized_state.virtual_machines.tags")
