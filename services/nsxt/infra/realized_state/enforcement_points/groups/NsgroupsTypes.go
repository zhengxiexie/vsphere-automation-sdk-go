...
func nsgroupsGetInputType() vapiBindings_.StructType {
	...
	fields["nsgroup_name"] = vapiBindings_.NewStringType()
...
func nsgroupsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["nsgroup_name"] = vapiBindings_.NewStringType()
	paramsTypeMap["enforcementPointName"] = vapiBindings_.NewStringType()
	paramsTypeMap["nsgroupName"] = vapiBindings_.NewStringType()
