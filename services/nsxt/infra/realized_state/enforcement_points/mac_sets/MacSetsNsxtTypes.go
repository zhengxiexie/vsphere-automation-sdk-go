...
func macSetsNsxtGetInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["enforcement_point_name"] = vapiBindings_.NewStringType()
	fields["mac_set_name"] = vapiBindings_.NewStringType()
...
func MacSetsNsxtGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.GenericPolicyRealizedResourceBindingType)
}

func macSetsNsxtGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["mac_set_name"] = vapiBindings_.NewStringType()
	paramsTypeMap["enforcementPointName"] = vapiBindings_.NewStringType()
	paramsTypeMap["macSetName"] = vapiBindings_.NewStringType()
...
func macSetsNsxtListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["enforcement_point_name"] = vapiBindings_.NewStringType()
...
func MacSetsNsxtListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.GenericPolicyRealizedResourceListResultBindingType)
}

func macSetsNsxtListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
