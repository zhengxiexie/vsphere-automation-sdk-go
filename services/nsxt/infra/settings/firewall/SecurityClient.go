...
func (sIface *securityClient) Get() (nsx_policyModel.DfwFirewallConfiguration, error) {
...
func (sIface *securityClient) Patch(dfwFirewallConfigurationParam nsx_policyModel.DfwFirewallConfiguration) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *securityClient) Update(dfwFirewallConfigurationParam nsx_policyModel.DfwFirewallConfiguration) (nsx_policyModel.DfwFirewallConfiguration, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
