...
type StatusClient interface {
	...
	List(transportNodeIdParam string, enforcementPointPathParam *string) (nsx_policyModel.IdfwVirtualMachineStatusListResult, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.settings.firewall.idfw.transport_nodes.vms.status")
...
func (sIface *statusClient) List(transportNodeIdParam string, enforcementPointPathParam *string) (nsx_policyModel.IdfwVirtualMachineStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.IdfwVirtualMachineStatusListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.IdfwVirtualMachineStatusListResult), nil
	} else {
