...
func ClusterGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ComputeClusterIdfwConfigurationBindingType)
}
...
func clusterListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
...
func ClusterListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ComputeClusterIdfwConfigurationListResultBindingType)
}

func clusterListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
...
func clusterPatchInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["cluster_id"] = vapiBindings_.NewStringType()
	fields["compute_cluster_idfw_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.ComputeClusterIdfwConfigurationBindingType)
	fieldNameMap["cluster_id"] = "ClusterId"
...
func ClusterPatchOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func clusterPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	fieldNameMap["compute_cluster_idfw_configuration"] = "ComputeClusterIdfwConfiguration"
	paramsTypeMap["cluster_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["compute_cluster_idfw_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.ComputeClusterIdfwConfigurationBindingType)
	paramsTypeMap["clusterId"] = vapiBindings_.NewStringType()
	pathParams["cluster_id"] = "clusterId"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
