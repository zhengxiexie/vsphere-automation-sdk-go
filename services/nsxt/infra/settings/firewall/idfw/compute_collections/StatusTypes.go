...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.IdfwComputeCollectionStatusBindingType)
}
...
func StatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.IdfwComputeCollectionListResultBindingType)
}
