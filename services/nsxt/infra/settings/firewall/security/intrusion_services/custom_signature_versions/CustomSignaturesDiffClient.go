...
type CustomSignaturesDiffClient interface {
	...
	Get(versionIdParam string) (nsx_policyModel.IdsCustomSignaturesDiff, error)
}
...
func NewCustomSignaturesDiffClient(connector vapiProtocolClient_.Connector) *customSignaturesDiffClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.custom_signature_versions.custom_signatures_diff")
...
func (cIface *customSignaturesDiffClient) Get(versionIdParam string) (nsx_policyModel.IdsCustomSignaturesDiff, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.custom_signature_versions.custom_signatures_diff", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsCustomSignaturesDiff
