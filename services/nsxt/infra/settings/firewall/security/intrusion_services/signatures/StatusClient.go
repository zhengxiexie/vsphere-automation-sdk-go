...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.signatures.status")
...
func (sIface *statusClient) Get(enforcementPointPathParam *string) (nsx_policyModel.IdsSignatureStatus, error) {
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.IdsSignatureStatus), nil
	} else {
