...
type RestoreClient interface {
	...
	Advance(advanceClusterRestoreRequestParam nsx_policyModel.AdvanceClusterRestoreRequest) (nsx_policyModel.ClusterRestoreStatus, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Cancel() (nsx_policyModel.ClusterRestoreStatus, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Retry() (nsx_policyModel.ClusterRestoreStatus, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Start(initiateClusterRestoreRequestParam nsx_policyModel.InitiateClusterRestoreRequest) (nsx_policyModel.ClusterRestoreStatus, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Suspend() (nsx_policyModel.ClusterRestoreStatus, error)
}
...
func NewRestoreClient(connector vapiProtocolClient_.Connector) *restoreClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.cluster.restore")
...
func (rIface *restoreClient) Advance(advanceClusterRestoreRequestParam nsx_policyModel.AdvanceClusterRestoreRequest) (nsx_policyModel.ClusterRestoreStatus, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.ClusterRestoreStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ClusterRestoreStatus), nil
	} else {
...
func (rIface *restoreClient) Cancel() (nsx_policyModel.ClusterRestoreStatus, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
...
func (rIface *restoreClient) Retry() (nsx_policyModel.ClusterRestoreStatus, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
...
func (rIface *restoreClient) Start(initiateClusterRestoreRequestParam nsx_policyModel.InitiateClusterRestoreRequest) (nsx_policyModel.ClusterRestoreStatus, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
...
func (rIface *restoreClient) Suspend() (nsx_policyModel.ClusterRestoreStatus, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
