...
type BackuptimestampsClient interface {
	...
	Get(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ClusterBackupInfoListResult, error)
}
...
func NewBackuptimestampsClient(connector vapiProtocolClient_.Connector) *backuptimestampsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.cluster.restore.backuptimestamps")
...
func (bIface *backuptimestampsClient) Get(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ClusterBackupInfoListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.ClusterBackupInfoListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ClusterBackupInfoListResult), nil
	} else {
