...
type ApiServiceClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(apiServiceConfigParam nsx_policyModel.ApiServiceConfig) (nsx_policyModel.ApiServiceConfig, error)
}
...
func NewApiServiceClient(connector vapiProtocolClient_.Connector) *apiServiceClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.cluster.api_service")
...
func (aIface *apiServiceClient) Get() (nsx_policyModel.ApiServiceConfig, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.ApiServiceConfig
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ApiServiceConfig), nil
	} else {
...
func (aIface *apiServiceClient) Update(apiServiceConfigParam nsx_policyModel.ApiServiceConfig) (nsx_policyModel.ApiServiceConfig, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
