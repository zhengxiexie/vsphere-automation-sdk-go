...
type HistoryClient interface {
	...
	Get() (nsx_policyModel.BackupOperationHistory, error)
}
...
func NewHistoryClient(connector vapiProtocolClient_.Connector) *historyClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.cluster.backups.history")
...
func (hIface *historyClient) Get() (nsx_policyModel.BackupOperationHistory, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.BackupOperationHistory
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.BackupOperationHistory), nil
	} else {
