...
type RetrieveClient interface {
	...
	Create(regTokenQueryParam nsx_policyModel.RegTokenQuery) (nsx_policyModel.RegistrationToken, error)
}
...
func NewRetrieveClient(connector vapiProtocolClient_.Connector) *retrieveClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.aaa.registration_token.retrieve")
...
func (rIface *retrieveClient) Create(regTokenQueryParam nsx_policyModel.RegTokenQuery) (nsx_policyModel.RegistrationToken, error) {
