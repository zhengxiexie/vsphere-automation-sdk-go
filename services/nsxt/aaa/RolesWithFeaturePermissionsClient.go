...
type RolesWithFeaturePermissionsClient interface {
	...
	List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoleWithFeaturesListResult, error)
}
...
func NewRolesWithFeaturePermissionsClient(connector vapiProtocolClient_.Connector) *rolesWithFeaturePermissionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.aaa.roles_with_feature_permissions")
...
func (rIface *rolesWithFeaturePermissionsClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoleWithFeaturesListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.RoleWithFeaturesListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.RoleWithFeaturesListResult), nil
	} else {
