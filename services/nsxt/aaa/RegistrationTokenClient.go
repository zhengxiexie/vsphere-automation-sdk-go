...
func NewRegistrationTokenClient(connector vapiProtocolClient_.Connector) *registrationTokenClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.aaa.registration_token")
...
func (rIface *registrationTokenClient) Create() (nsx_policyModel.RegistrationToken, error) {
...
func (rIface *registrationTokenClient) Get(tokenParam string) (nsx_policyModel.RegistrationToken, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
