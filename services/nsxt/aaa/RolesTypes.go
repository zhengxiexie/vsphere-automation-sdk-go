...
func rolesCloneInputType() vapiBindings_.StructType {
	...
	fields["new_role"] = vapiBindings_.NewReferenceType(nsx_policyModel.NewRoleBindingType)
...
func RolesCloneOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.NewRoleBindingType)
}
...
func rolesCloneRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["role"] = "Role"
	fieldNameMap["new_role"] = "NewRole"
	paramsTypeMap["new_role"] = vapiBindings_.NewReferenceType(nsx_policyModel.NewRoleBindingType)
...
func RolesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RoleWithFeaturesBindingType)
}
...
func RolesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RoleListResultBindingType)
}
...
func rolesUpdateInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["role"] = vapiBindings_.NewStringType()
	fields["role_with_features"] = vapiBindings_.NewReferenceType(nsx_policyModel.RoleWithFeaturesBindingType)
	fieldNameMap["role"] = "Role"
...
func rolesUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["role_with_features"] = "RoleWithFeatures"
	paramsTypeMap["role"] = vapiBindings_.NewStringType()
	paramsTypeMap["role_with_features"] = vapiBindings_.NewReferenceType(nsx_policyModel.RoleWithFeaturesBindingType)
	paramsTypeMap["role"] = vapiBindings_.NewStringType()
	pathParams["role"] = "role"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
...
func rolesValidateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["feature_permission_array"] = vapiBindings_.NewReferenceType(nsx_policyModel.FeaturePermissionArrayBindingType)
...
func RolesValidateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RecommendedFeaturePermissionListResultBindingType)
}
...
func rolesValidateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["feature_permission_array"] = vapiBindings_.NewReferenceType(nsx_policyModel.FeaturePermissionArrayBindingType)
	fieldNameMap["feature_permission_array"] = "FeaturePermissionArray"
	paramsTypeMap["feature_permission_array"] = vapiBindings_.NewReferenceType(nsx_policyModel.FeaturePermissionArrayBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
