...
func ldapServersGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/identity-firewall-stores/{identityFirewallStoreId}/ldap-servers/{ldapServerId}",
		"",
		resultHeaders,
		200,
		"",
...
func ldapServersListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/identity-firewall-stores/{identityFirewallStoreId}/ldap-servers",
		"",
		resultHeaders,
		200,
		"",
