...
type StatisticsClient interface {
	...
	List(domainIdParam string, idsPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.IdsSecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, idsPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.IdsSecurityPolicyStatisticsListResult, error) {
