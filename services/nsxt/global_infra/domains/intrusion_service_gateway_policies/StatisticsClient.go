...
type StatisticsClient interface {
	...
	List(domainIdParam string, policyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.IdsSecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.domains.intrusion_service_gateway_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, policyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.IdsSecurityPolicyStatisticsListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.IdsSecurityPolicyStatisticsListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.intrusion_service_gateway_policies.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsSecurityPolicyStatisticsListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.IdsSecurityPolicyStatisticsListResult), nil
	} else {
