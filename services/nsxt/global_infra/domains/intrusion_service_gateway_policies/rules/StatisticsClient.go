...
type StatisticsClient interface {
	...
	List(domainIdParam string, policyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.IdsRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.domains.intrusion_service_gateway_policies.rules.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, policyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.IdsRuleStatisticsListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.IdsRuleStatisticsListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.intrusion_service_gateway_policies.rules.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsRuleStatisticsListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.IdsRuleStatisticsListResult), nil
	} else {
