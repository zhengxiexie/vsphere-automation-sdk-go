...
func rulesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/domains/{domainId}/intrusion-service-gateway-policies/{policyId}/rules/{ruleId}",
		"",
		resultHeaders,
		204,
		"",
...
func rulesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/intrusion-service-gateway-policies/{policyId}/rules",
		"",
		resultHeaders,
		200,
		"",
