...
func bgpSummaryListInputType() vapiBindings_.StructType {
...
func BgpSummaryListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyEdgeClusterRemoteTunnelBgpSummaryBindingType)
}

func bgpSummaryListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-clusters/{edgeClusterId}/remote-tunnel-connectivity/bgp-summary",
		"",
		resultHeaders,
		200,
		"",
