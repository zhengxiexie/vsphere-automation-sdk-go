...
type BgpSummaryClient interface {
	...
	List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyEdgeClusterInterSiteBgpSummary, error)
}
...
func NewBgpSummaryClient(connector vapiProtocolClient_.Connector) *bgpSummaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.inter_site.bgp_summary")
...
func (bIface *bgpSummaryClient) List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyEdgeClusterInterSiteBgpSummary, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.PolicyEdgeClusterInterSiteBgpSummary
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.PolicyEdgeClusterInterSiteBgpSummary), nil
	} else {
