...
type VirtualMachinesClient interface {
	...
	List(tier0IdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RealizedVirtualMachineListResult, error)
}
...
func NewVirtualMachinesClient(connector vapiProtocolClient_.Connector) *virtualMachinesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_0s.groups.members.virtual_machines")
...
func (vIface *virtualMachinesClient) List(tier0IdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RealizedVirtualMachineListResult, error) {
