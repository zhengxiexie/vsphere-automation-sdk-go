...
func NewRulesClient(connector vapiProtocolClient_.Connector) *rulesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.firewall.rules")
...
func (rIface *rulesClient) List(scopeParam string, enforcementPointPathParam *string, parentPathParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error) {
