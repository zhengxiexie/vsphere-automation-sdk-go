...
func NewCompleteClient(connector vapiProtocolClient_.Connector) *completeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.drafts.complete")
...
func (cIface *completeClient) Get(draftIdParam string) (nsx_policyModel.Infra, error) {
