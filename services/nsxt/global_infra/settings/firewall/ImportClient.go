...
type ImportClient interface {
	...
	Cancel() (nsx_policyModel.ImportTask, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get() (nsx_policyModel.ImportTask, error)
}
...
func NewImportClient(connector vapiProtocolClient_.Connector) *importClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.settings.firewall.import")
...
func (iIface *importClient) Cancel() (nsx_policyModel.ImportTask, error) {
...
func (iIface *importClient) Get() (nsx_policyModel.ImportTask, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
