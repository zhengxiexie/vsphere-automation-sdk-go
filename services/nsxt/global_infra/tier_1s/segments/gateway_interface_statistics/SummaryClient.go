...
type SummaryClient interface {
	...
	Get(tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyInterfaceStatisticsSummary, error)
}
...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.segments.gateway_interface_statistics.summary")
...
func (sIface *summaryClient) Get(tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyInterfaceStatisticsSummary, error) {
