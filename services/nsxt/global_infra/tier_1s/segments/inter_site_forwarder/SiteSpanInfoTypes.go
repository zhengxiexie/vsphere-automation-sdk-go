...
// Possible value for ``bgpNeighborType`` of method SiteSpanInfo#get.
const SiteSpanInfo_GET_BGP_NEIGHBOR_TYPE_INTER_SR = "INTER_SR"

// Possible value for ``bgpNeighborType`` of method SiteSpanInfo#get.
const SiteSpanInfo_GET_BGP_NEIGHBOR_TYPE_USER = "USER"

// Possible value for ``source`` of method SiteSpanInfo#get.
const SiteSpanInfo_GET_SOURCE_REALTIME = "realtime"

// Possible value for ``source`` of method SiteSpanInfo#get.
const SiteSpanInfo_GET_SOURCE_CACHED = "cached"

// Possible value for ``statsType`` of method SiteSpanInfo#get.
const SiteSpanInfo_GET_STATS_TYPE_STATS = "DATAPATH_STATS"

func siteSpanInfoGetInputType() vapiBindings_.StructType {
...
func SiteSpanInfoGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.SegmentL2ForwarderSiteSpanInfoBindingType)
}

func siteSpanInfoGetRestMetadata() vapiProtocol_.OperationRestMetadata {
