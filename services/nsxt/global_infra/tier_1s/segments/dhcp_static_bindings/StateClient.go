...
type StateClient interface {
	...
	Get(tier1IdParam string, segmentIdParam string, bindingIdParam string) (nsx_policyModel.DhcpStaticBindingState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.segments.dhcp_static_bindings.state")
...
func (sIface *stateClient) Get(tier1IdParam string, segmentIdParam string, bindingIdParam string) (nsx_policyModel.DhcpStaticBindingState, error) {
