...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.GatewayL2ForwarderSiteSpanInfoBindingType)
}
...
func statusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServicesId}/inter-site-forwarder/status",
		"",
		resultHeaders,
		200,
		"",
