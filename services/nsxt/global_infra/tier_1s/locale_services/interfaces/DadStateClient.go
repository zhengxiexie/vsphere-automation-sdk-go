...
type DadStateClient interface {
	...
	Get(tier1IdParam string, localeServiceIdParam string, interfaceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.InterfaceDADState, error)
}
...
func NewDadStateClient(connector vapiProtocolClient_.Connector) *dadStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.locale_services.interfaces.dad_state")
...
func (dIface *dadStateClient) Get(tier1IdParam string, localeServiceIdParam string, interfaceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.InterfaceDADState, error) {
