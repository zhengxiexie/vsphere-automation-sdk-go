...
type StateClient interface {
	...
	Get(segmentIdParam string, bindingIdParam string) (nsx_policyModel.DhcpStaticBindingState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.segments.dhcp_static_bindings.state")
...
func (sIface *stateClient) Get(segmentIdParam string, bindingIdParam string) (nsx_policyModel.DhcpStaticBindingState, error) {
