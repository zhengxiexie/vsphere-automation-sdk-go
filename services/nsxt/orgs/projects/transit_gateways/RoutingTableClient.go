...
func NewRoutingTableClient(connector vapiProtocolClient_.Connector) *routingTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing_table")
...
func (rIface *routingTableClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, componentTypeParam *string, cursorParam *string, edgeIdParam *string, edgePathParam *string, enforcementPointPathParam *string, hostIdParam *string, hostPathParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, routeSourceParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoutingTableListResult, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RoutingTableListResult
