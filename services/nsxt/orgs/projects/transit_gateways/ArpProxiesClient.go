...
type ArpProxiesClient interface {
	...
	List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.PolicyArpProxyTableListResult, error)
}
...
func NewArpProxiesClient(connector vapiProtocolClient_.Connector) *arpProxiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.arp_proxies")
...
func (aIface *arpProxiesClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.PolicyArpProxyTableListResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.arp_proxies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyArpProxyTableListResult
