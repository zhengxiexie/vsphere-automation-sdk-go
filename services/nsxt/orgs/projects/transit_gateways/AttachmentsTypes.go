...
func attachmentsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/attachments/{attachmentId}",
		"",
		resultHeaders,
		204,
		"",
...
func AttachmentsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayAttachmentBindingType)
}
...
func attachmentsListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
...
func AttachmentsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayAttachmentListResultBindingType)
}

func attachmentsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/attachments",
		"",
		resultHeaders,
		200,
		"",
...
func attachmentsPatchInputType() vapiBindings_.StructType {
	...
	fields["transit_gateway_id"] = vapiBindings_.NewStringType()
	fields["attachment_id"] = vapiBindings_.NewStringType()
	fields["transit_gateway_attachment"] = vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayAttachmentBindingType)
	fieldNameMap["org_id"] = "OrgId"
	fieldNameMap["project_id"] = "ProjectId"
	fieldNameMap["transit_gateway_id"] = "TransitGatewayId"
	fieldNameMap["attachment_id"] = "AttachmentId"
	fieldNameMap["transit_gateway_attachment"] = "TransitGatewayAttachment"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func attachmentsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["org_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["attachment_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["transit_gateway_attachment"] = vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayAttachmentBindingType)
	paramsTypeMap["orgId"] = vapiBindings_.NewStringType()
	paramsTypeMap["projectId"] = vapiBindings_.NewStringType()
	paramsTypeMap["transitGatewayId"] = vapiBindings_.NewStringType()
	paramsTypeMap["attachmentId"] = vapiBindings_.NewStringType()
...
func attachmentsUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
...
func AttachmentsUpdateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayAttachmentBindingType)
}

func attachmentsUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
