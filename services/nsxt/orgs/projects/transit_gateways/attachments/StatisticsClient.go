...
type StatisticsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, transitGatewayIdParam string, attachmentIdParam string) (nsx_policyModel.TransitGatewayAttachmentStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.attachments.statistics")
...
func (sIface *statisticsClient) Get(orgIdParam string, projectIdParam string, transitGatewayIdParam string, attachmentIdParam string) (nsx_policyModel.TransitGatewayAttachmentStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.attachments.statistics", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TransitGatewayAttachmentStatistics
