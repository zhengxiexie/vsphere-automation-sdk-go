...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.PolicyNatRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.nat.nat_rules.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.PolicyNatRuleStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.nat.nat_rules.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyNatRuleStatisticsListResult
