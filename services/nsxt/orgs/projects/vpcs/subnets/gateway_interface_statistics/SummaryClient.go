...
type SummaryClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyInterfaceStatisticsSummary, error)
}
...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.gateway_interface_statistics.summary")
...
func (sIface *summaryClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyInterfaceStatisticsSummary, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.gateway_interface_statistics.summary", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyInterfaceStatisticsSummary
