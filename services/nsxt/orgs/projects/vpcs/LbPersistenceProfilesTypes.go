...
func lbPersistenceProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/lb-persistence-profiles/{lbPersistenceProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func lbPersistenceProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/lb-persistence-profiles",
		"",
		resultHeaders,
		200,
		"",
