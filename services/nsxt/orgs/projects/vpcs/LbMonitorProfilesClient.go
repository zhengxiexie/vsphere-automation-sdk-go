...
type LbMonitorProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string) (*vapiData_.StructValue, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string, lbMonitorProfileParam *vapiData_.StructValue) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string, lbMonitorProfileParam *vapiData_.StructValue) (*vapiData_.StructValue, error)
}
...
func NewLbMonitorProfilesClient(connector vapiProtocolClient_.Connector) *lbMonitorProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_monitor_profiles")
...
func (lIface *lbMonitorProfilesClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_monitor_profiles", "delete", inputDataValue, executionContext)
...
func (lIface *lbMonitorProfilesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string) (*vapiData_.StructValue, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_monitor_profiles", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
...
func (lIface *lbMonitorProfilesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBMonitorProfileListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_monitor_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBMonitorProfileListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbMonitorProfilesClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string, lbMonitorProfileParam *vapiData_.StructValue) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_monitor_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbMonitorProfilesClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbMonitorProfileIdParam string, lbMonitorProfileParam *vapiData_.StructValue) (*vapiData_.StructValue, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_monitor_profiles", "update", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
