...
func subnetPortsListInputType() vapiBindings_.StructType {
...
func SubnetPortsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyGroupMembersListResultBindingType)
}

func subnetPortsListRestMetadata() vapiProtocol_.OperationRestMetadata {
