...
// Possible value for ``source`` of method Usage#get.
const Usage_GET_SOURCE_REALTIME = "realtime"

// Possible value for ``source`` of method Usage#get.
const Usage_GET_SOURCE_CACHED = "cached"
...
func usageGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/vpc-lbs/{vpcLbId}/usage",
		"",
		resultHeaders,
		200,
		"",
