...
type DetailedStatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, vpcLbIdParam string, enforcementPointPathParam *string, includeInstanceDetailsParam *bool, sourceParam *string, transportNodeIdsParam *string) (nsx_policyModel.AggregateLBServiceStatus, error)
}
...
func (dIface *detailedStatusClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, vpcLbIdParam string, enforcementPointPathParam *string, includeInstanceDetailsParam *bool, sourceParam *string, transportNodeIdsParam *string) (nsx_policyModel.AggregateLBServiceStatus, error) {
