...
func DetailedStatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.AggregateLBVirtualServerStatusBindingType)
}
...
func detailedStatusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/vpc-lbs/{vpcLbId}/vpc-lb-virtual-servers/{vpcLbVirtualServerId}/detailed-status",
		"",
		resultHeaders,
		200,
		"",
