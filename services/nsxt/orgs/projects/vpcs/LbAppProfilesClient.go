...
type LbAppProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string) (*vapiData_.StructValue, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string, lbAppProfileParam *vapiData_.StructValue) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string, lbAppProfileParam *vapiData_.StructValue) (*vapiData_.StructValue, error)
}
...
func NewLbAppProfilesClient(connector vapiProtocolClient_.Connector) *lbAppProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_app_profiles")
...
func (lIface *lbAppProfilesClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_app_profiles", "delete", inputDataValue, executionContext)
...
func (lIface *lbAppProfilesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string) (*vapiData_.StructValue, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_app_profiles", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
...
func (lIface *lbAppProfilesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBAppProfileListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_app_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBAppProfileListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbAppProfilesClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string, lbAppProfileParam *vapiData_.StructValue) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_app_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbAppProfilesClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbAppProfileIdParam string, lbAppProfileParam *vapiData_.StructValue) (*vapiData_.StructValue, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_app_profiles", "update", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
