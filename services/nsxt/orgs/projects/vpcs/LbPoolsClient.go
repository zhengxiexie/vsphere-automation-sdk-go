...
type LbPoolsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string) (nsx_policyModel.LBPool, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string, lbPoolParam nsx_policyModel.LBPool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string, lbPoolParam nsx_policyModel.LBPool) (nsx_policyModel.LBPool, error)
}
...
func NewLbPoolsClient(connector vapiProtocolClient_.Connector) *lbPoolsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_pools")
...
func (lIface *lbPoolsClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_pools", "delete", inputDataValue, executionContext)
...
func (lIface *lbPoolsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string) (nsx_policyModel.LBPool, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_pools", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBPool
	if methodResult.IsSuccess() {
...
func (lIface *lbPoolsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBPoolListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_pools", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBPoolListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbPoolsClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string, lbPoolParam nsx_policyModel.LBPool) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_pools", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbPoolsClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbPoolIdParam string, lbPoolParam nsx_policyModel.LBPool) (nsx_policyModel.LBPool, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_pools", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBPool
	if methodResult.IsSuccess() {
