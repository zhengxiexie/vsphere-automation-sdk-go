...
type LbVirtualServersClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string) (nsx_policyModel.LBVirtualServer, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string, lbVirtualServerParam nsx_policyModel.LBVirtualServer) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string, lbVirtualServerParam nsx_policyModel.LBVirtualServer) (nsx_policyModel.LBVirtualServer, error)
}
...
func NewLbVirtualServersClient(connector vapiProtocolClient_.Connector) *lbVirtualServersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_virtual_servers")
...
func (lIface *lbVirtualServersClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_virtual_servers", "delete", inputDataValue, executionContext)
...
func (lIface *lbVirtualServersClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string) (nsx_policyModel.LBVirtualServer, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_virtual_servers", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBVirtualServer
	if methodResult.IsSuccess() {
...
func (lIface *lbVirtualServersClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBVirtualServerListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_virtual_servers", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBVirtualServerListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbVirtualServersClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string, lbVirtualServerParam nsx_policyModel.LBVirtualServer) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_virtual_servers", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbVirtualServersClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbVirtualServerIdParam string, lbVirtualServerParam nsx_policyModel.LBVirtualServer) (nsx_policyModel.LBVirtualServer, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_virtual_servers", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBVirtualServer
	if methodResult.IsSuccess() {
