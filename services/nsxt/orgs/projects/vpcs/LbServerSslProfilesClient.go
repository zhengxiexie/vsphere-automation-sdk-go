...
type LbServerSslProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string) (nsx_policyModel.LBServerSslProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string, lbServerSslProfileParam nsx_policyModel.LBServerSslProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string, lbServerSslProfileParam nsx_policyModel.LBServerSslProfile) (nsx_policyModel.LBServerSslProfile, error)
}
...
func NewLbServerSslProfilesClient(connector vapiProtocolClient_.Connector) *lbServerSslProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_server_ssl_profiles")
...
func (lIface *lbServerSslProfilesClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_server_ssl_profiles", "delete", inputDataValue, executionContext)
...
func (lIface *lbServerSslProfilesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string) (nsx_policyModel.LBServerSslProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_server_ssl_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBServerSslProfile
	if methodResult.IsSuccess() {
...
func (lIface *lbServerSslProfilesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBServerSslProfileListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_server_ssl_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBServerSslProfileListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbServerSslProfilesClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string, lbServerSslProfileParam nsx_policyModel.LBServerSslProfile) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_server_ssl_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbServerSslProfilesClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbServerSslProfileIdParam string, lbServerSslProfileParam nsx_policyModel.LBServerSslProfile) (nsx_policyModel.LBServerSslProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_server_ssl_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBServerSslProfile
	if methodResult.IsSuccess() {
