...
func lbMonitorProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/lb-monitor-profiles/{lbMonitorProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func lbMonitorProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/lb-monitor-profiles",
		"",
		resultHeaders,
		200,
		"",
