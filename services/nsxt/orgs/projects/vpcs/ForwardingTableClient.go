...
type ForwardingTableClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, componentTypeParam *string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, routeSourceParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoutingTableListResult, error)
}
...
func NewForwardingTableClient(connector vapiProtocolClient_.Connector) *forwardingTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.forwarding_table")
...
func (fIface *forwardingTableClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, componentTypeParam *string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, routeSourceParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoutingTableListResult, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.forwarding_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RoutingTableListResult
