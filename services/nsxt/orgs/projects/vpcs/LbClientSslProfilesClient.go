...
type LbClientSslProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string) (nsx_policyModel.LBClientSslProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string, lbClientSslProfileParam nsx_policyModel.LBClientSslProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string, lbClientSslProfileParam nsx_policyModel.LBClientSslProfile) (nsx_policyModel.LBClientSslProfile, error)
}
...
func NewLbClientSslProfilesClient(connector vapiProtocolClient_.Connector) *lbClientSslProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_client_ssl_profiles")
...
func (lIface *lbClientSslProfilesClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_client_ssl_profiles", "delete", inputDataValue, executionContext)
...
func (lIface *lbClientSslProfilesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string) (nsx_policyModel.LBClientSslProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_client_ssl_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBClientSslProfile
	if methodResult.IsSuccess() {
...
func (lIface *lbClientSslProfilesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBClientSslProfileListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_client_ssl_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBClientSslProfileListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbClientSslProfilesClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string, lbClientSslProfileParam nsx_policyModel.LBClientSslProfile) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_client_ssl_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbClientSslProfilesClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbClientSslProfileIdParam string, lbClientSslProfileParam nsx_policyModel.LBClientSslProfile) (nsx_policyModel.LBClientSslProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_client_ssl_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBClientSslProfile
	if methodResult.IsSuccess() {
