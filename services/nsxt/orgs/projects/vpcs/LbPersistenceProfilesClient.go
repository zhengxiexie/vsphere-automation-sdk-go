...
type LbPersistenceProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string) (*vapiData_.StructValue, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string, lbPersistenceProfileParam *vapiData_.StructValue) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string, lbPersistenceProfileParam *vapiData_.StructValue) (*vapiData_.StructValue, error)
}
...
func NewLbPersistenceProfilesClient(connector vapiProtocolClient_.Connector) *lbPersistenceProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.lb_persistence_profiles")
...
func (lIface *lbPersistenceProfilesClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_persistence_profiles", "delete", inputDataValue, executionContext)
...
func (lIface *lbPersistenceProfilesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string) (*vapiData_.StructValue, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_persistence_profiles", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
...
func (lIface *lbPersistenceProfilesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBPersistenceProfileListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_persistence_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBPersistenceProfileListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbPersistenceProfilesClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string, lbPersistenceProfileParam *vapiData_.StructValue) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_persistence_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbPersistenceProfilesClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, lbPersistenceProfileIdParam string, lbPersistenceProfileParam *vapiData_.StructValue) (*vapiData_.StructValue, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.lb_persistence_profiles", "update", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
