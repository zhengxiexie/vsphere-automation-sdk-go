...
type IpsecVpnTunnelProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, tunnelProfileIdParam string, ipSecVpnTunnelProfileParam nsx_policyModel.IPSecVpnTunnelProfile) (nsx_policyModel.IPSecVpnTunnelProfile, error)
}
...
func NewIpsecVpnTunnelProfilesClient(connector vapiProtocolClient_.Connector) *ipsecVpnTunnelProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_tunnel_profiles")
...
func (iIface *ipsecVpnTunnelProfilesClient) Delete(orgIdParam string, projectIdParam string, tunnelProfileIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_tunnel_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipsecVpnTunnelProfilesClient) Get(orgIdParam string, projectIdParam string, tunnelProfileIdParam string) (nsx_policyModel.IPSecVpnTunnelProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_tunnel_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnTunnelProfile
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnTunnelProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnTunnelProfileListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_tunnel_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnTunnelProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnTunnelProfilesClient) Patch(orgIdParam string, projectIdParam string, tunnelProfileIdParam string, ipSecVpnTunnelProfileParam nsx_policyModel.IPSecVpnTunnelProfile) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_tunnel_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipsecVpnTunnelProfilesClient) Update(orgIdParam string, projectIdParam string, tunnelProfileIdParam string, ipSecVpnTunnelProfileParam nsx_policyModel.IPSecVpnTunnelProfile) (nsx_policyModel.IPSecVpnTunnelProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_tunnel_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnTunnelProfile
	if methodResult.IsSuccess() {
