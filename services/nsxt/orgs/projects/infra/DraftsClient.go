...
type DraftsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyDraftListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam nsx_policyModel.PolicyDraft) (nsx_policyModel.PolicyDraft, error)
}
...
func (dIface *draftsClient) Get(orgIdParam string, projectIdParam string, draftIdParam string) (nsx_policyModel.PolicyDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
...
func (dIface *draftsClient) List(orgIdParam string, projectIdParam string, autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyDraftListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
...
func (dIface *draftsClient) Patch(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam nsx_policyModel.PolicyDraft) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
...
func (dIface *draftsClient) Update(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam nsx_policyModel.PolicyDraft) (nsx_policyModel.PolicyDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
