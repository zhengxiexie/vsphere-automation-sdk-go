...
type StatisticsClient interface {
	...
	List(domainIdParam string, securityPolicyIdParam string, orgIdParam string, projectIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.security_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, securityPolicyIdParam string, orgIdParam string, projectIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error) {
