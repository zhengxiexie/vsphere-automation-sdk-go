...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, domainIdParam string, securityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error)
}
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, domainIdParam string, securityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error) {
