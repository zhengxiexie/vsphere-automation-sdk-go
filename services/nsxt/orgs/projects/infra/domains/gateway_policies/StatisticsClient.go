...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, domainIdParam string, gatewayPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.gateway_policies.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, domainIdParam string, gatewayPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error) {
