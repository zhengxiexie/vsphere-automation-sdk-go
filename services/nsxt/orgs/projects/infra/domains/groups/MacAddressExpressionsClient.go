...
type MacAddressExpressionsClient interface {
	...
	Create(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, expressionIdParam string, mACAddressListParam nsx_policyModel.MACAddressList, actionParam string) error
...
func NewMacAddressExpressionsClient(connector vapiProtocolClient_.Connector) *macAddressExpressionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.mac_address_expressions")
...
func (mIface *macAddressExpressionsClient) Create(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, expressionIdParam string, mACAddressListParam nsx_policyModel.MACAddressList, actionParam string) error {
