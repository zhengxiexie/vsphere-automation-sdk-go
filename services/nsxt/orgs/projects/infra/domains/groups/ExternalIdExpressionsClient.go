...
func NewExternalIdExpressionsClient(connector vapiProtocolClient_.Connector) *externalIdExpressionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.external_id_expressions")
...
func (eIface *externalIdExpressionsClient) Create(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, expressionIdParam string, groupMemberListParam nsx_policyModel.GroupMemberList, actionParam string) error {
