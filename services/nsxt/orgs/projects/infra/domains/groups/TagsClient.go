...
type TagsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string) (nsx_policyModel.GroupTagsList, error)
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.tags")
...
func (tIface *tagsClient) Get(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string) (nsx_policyModel.GroupTagsList, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.GroupTagsList
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.GroupTagsList), nil
	} else {
