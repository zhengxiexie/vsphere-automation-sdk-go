...
type ConsolidatedEffectiveIpAddressesClient interface {
	...
	List(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, ipFilterParam *string, pageSizeParam *int64, siteIdParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ConsolidatedEffectiveIPAddressMemberListResult, error)
}
...
func NewConsolidatedEffectiveIpAddressesClient(connector vapiProtocolClient_.Connector) *consolidatedEffectiveIpAddressesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.members.consolidated_effective_ip_addresses")
