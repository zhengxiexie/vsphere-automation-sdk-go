...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.PolicyNatRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string, actionParam *string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.PolicyNatRuleStatisticsListResult, error) {
