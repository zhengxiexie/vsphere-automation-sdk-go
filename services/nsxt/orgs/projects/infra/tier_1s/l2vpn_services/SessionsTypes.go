...
func sessionsCreatewithpeercodeRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"l2_VPN_session_data",
		"POST",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/l2vpn-services/{serviceId}/sessions/{sessionId}",
		"",
		resultHeaders,
		204,
		"",
...
func sessionsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/l2vpn-services/{serviceId}/sessions",
		"",
		resultHeaders,
		200,
		"",
