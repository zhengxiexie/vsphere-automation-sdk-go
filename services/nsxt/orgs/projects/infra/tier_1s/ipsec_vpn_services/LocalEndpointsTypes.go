...
func localEndpointsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/ipsec-vpn-services/{serviceId}/local-endpoints/{localEndpointId}",
		"",
		resultHeaders,
		204,
		"",
...
func localEndpointsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/ipsec-vpn-services/{serviceId}/local-endpoints",
		"",
		resultHeaders,
		200,
		"",
