...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.gateway_interface_statistics.summary")
...
func (sIface *summaryClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyInterfaceStatisticsSummary, error) {
