...
type NslookupClient interface {
	...
	Get(orgIdParam string, projectIdParam string, tier1IdParam string, addressParam *string, enforcementPointPathParam *string) (nsx_policyModel.AggregatePolicyDnsAnswer, error)
}
...
func NewNslookupClient(connector vapiProtocolClient_.Connector) *nslookupClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder.nslookup")
...
func (nIface *nslookupClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, addressParam *string, enforcementPointPathParam *string) (nsx_policyModel.AggregatePolicyDnsAnswer, error) {
