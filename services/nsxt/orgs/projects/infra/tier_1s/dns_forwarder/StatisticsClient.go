...
type StatisticsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, tier1IdParam string, enforcementPointPathParam *string) (nsx_policyModel.AggregateDNSForwarderStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder.statistics")
...
func (sIface *statisticsClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, enforcementPointPathParam *string) (nsx_policyModel.AggregateDNSForwarderStatistics, error) {
