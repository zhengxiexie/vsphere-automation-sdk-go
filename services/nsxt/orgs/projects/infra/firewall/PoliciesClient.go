...
func NewPoliciesClient(connector vapiProtocolClient_.Connector) *policiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.firewall.policies")
...
func (pIface *policiesClient) List(orgIdParam string, projectIdParam string, scopeParam string, enforcementPointPathParam *string, parentPathParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error) {
