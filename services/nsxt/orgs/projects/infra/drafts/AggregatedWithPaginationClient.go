...
type Aggregated_with_paginationClient interface {
	...
	Get(orgIdParam string, projectIdParam string, draftIdParam string, requestIdParam *string, rootPathParam *string) (nsx_policyModel.PolicyDraftPaginatedAggregatedConfigurationResult, error)
}
...
func NewAggregated_with_paginationClient(connector vapiProtocolClient_.Connector) *aggregated_with_paginationClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.drafts.aggregated_with_pagination")
...
func (aIface *aggregated_with_paginationClient) Get(orgIdParam string, projectIdParam string, draftIdParam string, requestIdParam *string, rootPathParam *string) (nsx_policyModel.PolicyDraftPaginatedAggregatedConfigurationResult, error) {
