...
type CustomSignaturesClient interface {
	...
	Get(orgIdParam string, projectIdParam string, versionIdParam string, sigIdParam string) (nsx_policyModel.IdsCustomSignature, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, versionIdParam string, cursorParam *string, includeParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsCustomSignatureListResult, error)
}
...
func NewCustomSignaturesClient(connector vapiProtocolClient_.Connector) *customSignaturesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.custom_signature_versions.custom_signatures")
...
func (cIface *customSignaturesClient) Get(orgIdParam string, projectIdParam string, versionIdParam string, sigIdParam string) (nsx_policyModel.IdsCustomSignature, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.custom_signature_versions.custom_signatures", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsCustomSignature
...
func (cIface *customSignaturesClient) List(orgIdParam string, projectIdParam string, versionIdParam string, cursorParam *string, includeParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsCustomSignatureListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.custom_signature_versions.custom_signatures", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsCustomSignatureListResult
	if methodResult.IsSuccess() {
