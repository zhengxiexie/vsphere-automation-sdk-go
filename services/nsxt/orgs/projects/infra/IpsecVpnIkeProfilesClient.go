...
type IpsecVpnIkeProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, ikeProfileIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, ikeProfileIdParam string) (nsx_policyModel.IPSecVpnIkeProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnIkeProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, ikeProfileIdParam string, ipSecVpnIkeProfileParam nsx_policyModel.IPSecVpnIkeProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, ikeProfileIdParam string, ipSecVpnIkeProfileParam nsx_policyModel.IPSecVpnIkeProfile) (nsx_policyModel.IPSecVpnIkeProfile, error)
}
...
func NewIpsecVpnIkeProfilesClient(connector vapiProtocolClient_.Connector) *ipsecVpnIkeProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_ike_profiles")
...
func (iIface *ipsecVpnIkeProfilesClient) Delete(orgIdParam string, projectIdParam string, ikeProfileIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_ike_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipsecVpnIkeProfilesClient) Get(orgIdParam string, projectIdParam string, ikeProfileIdParam string) (nsx_policyModel.IPSecVpnIkeProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_ike_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnIkeProfile
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnIkeProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnIkeProfileListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_ike_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnIkeProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnIkeProfilesClient) Patch(orgIdParam string, projectIdParam string, ikeProfileIdParam string, ipSecVpnIkeProfileParam nsx_policyModel.IPSecVpnIkeProfile) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_ike_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipsecVpnIkeProfilesClient) Update(orgIdParam string, projectIdParam string, ikeProfileIdParam string, ipSecVpnIkeProfileParam nsx_policyModel.IPSecVpnIkeProfile) (nsx_policyModel.IPSecVpnIkeProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_ike_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnIkeProfile
	if methodResult.IsSuccess() {
