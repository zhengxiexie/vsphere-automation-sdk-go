...
type IpsecVpnDpdProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, dpdProfileIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, dpdProfileIdParam string) (nsx_policyModel.IPSecVpnDpdProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnDpdProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, dpdProfileIdParam string, ipSecVpnDpdProfileParam nsx_policyModel.IPSecVpnDpdProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, dpdProfileIdParam string, ipSecVpnDpdProfileParam nsx_policyModel.IPSecVpnDpdProfile) (nsx_policyModel.IPSecVpnDpdProfile, error)
}
...
func NewIpsecVpnDpdProfilesClient(connector vapiProtocolClient_.Connector) *ipsecVpnDpdProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_dpd_profiles")
...
func (iIface *ipsecVpnDpdProfilesClient) Delete(orgIdParam string, projectIdParam string, dpdProfileIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_dpd_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipsecVpnDpdProfilesClient) Get(orgIdParam string, projectIdParam string, dpdProfileIdParam string) (nsx_policyModel.IPSecVpnDpdProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_dpd_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnDpdProfile
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnDpdProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnDpdProfileListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_dpd_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnDpdProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnDpdProfilesClient) Patch(orgIdParam string, projectIdParam string, dpdProfileIdParam string, ipSecVpnDpdProfileParam nsx_policyModel.IPSecVpnDpdProfile) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_dpd_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipsecVpnDpdProfilesClient) Update(orgIdParam string, projectIdParam string, dpdProfileIdParam string, ipSecVpnDpdProfileParam nsx_policyModel.IPSecVpnDpdProfile) (nsx_policyModel.IPSecVpnDpdProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipsec_vpn_dpd_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnDpdProfile
	if methodResult.IsSuccess() {
