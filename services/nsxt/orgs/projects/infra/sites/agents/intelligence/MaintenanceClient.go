...
func (mIface *maintenanceClient) Get(orgIdParam string, projectIdParam string) (nsx_policyModel.AnalyticsMaintenanceMode, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.agents.intelligence.maintenance", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AnalyticsMaintenanceMode
...
func (mIface *maintenanceClient) Update(orgIdParam string, projectIdParam string, analyticsMaintenanceModeParam nsx_policyModel.AnalyticsMaintenanceMode) (nsx_policyModel.AnalyticsMaintenanceMode, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.agents.intelligence.maintenance", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AnalyticsMaintenanceMode
	if methodResult.IsSuccess() {
