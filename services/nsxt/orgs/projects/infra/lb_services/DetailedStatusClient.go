...
type DetailedStatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, lbServiceIdParam string, enforcementPointPathParam *string, includeInstanceDetailsParam *bool, sourceParam *string, transportNodeIdsParam *string) (nsx_policyModel.AggregateLBServiceStatus, error)
}
...
func NewDetailedStatusClient(connector vapiProtocolClient_.Connector) *detailedStatusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.lb_services.detailed_status")
...
func (dIface *detailedStatusClient) Get(orgIdParam string, projectIdParam string, lbServiceIdParam string, enforcementPointPathParam *string, includeInstanceDetailsParam *bool, sourceParam *string, transportNodeIdsParam *string) (nsx_policyModel.AggregateLBServiceStatus, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.lb_services.detailed_status", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AggregateLBServiceStatus
