...
type ConstraintGlobalConfigClient interface {
	...
	Get(orgIdParam string, projectIdParam string) (nsx_policyModel.ConstraintGlobalConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, constraintGlobalConfigParam nsx_policyModel.ConstraintGlobalConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, constraintGlobalConfigParam nsx_policyModel.ConstraintGlobalConfig) (nsx_policyModel.ConstraintGlobalConfig, error)
}
...
func NewConstraintGlobalConfigClient(connector vapiProtocolClient_.Connector) *constraintGlobalConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.constraint_global_config")
...
func (cIface *constraintGlobalConfigClient) Get(orgIdParam string, projectIdParam string) (nsx_policyModel.ConstraintGlobalConfig, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.constraint_global_config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ConstraintGlobalConfig
...
func (cIface *constraintGlobalConfigClient) Patch(orgIdParam string, projectIdParam string, constraintGlobalConfigParam nsx_policyModel.ConstraintGlobalConfig) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.constraint_global_config", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *constraintGlobalConfigClient) Update(orgIdParam string, projectIdParam string, constraintGlobalConfigParam nsx_policyModel.ConstraintGlobalConfig) (nsx_policyModel.ConstraintGlobalConfig, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.constraint_global_config", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ConstraintGlobalConfig
	if methodResult.IsSuccess() {
