...
type ResourcesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, shareIdParam string, sharedResourceIdParam string) (nsx_policyModel.SharedResource, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, shareIdParam string, resourceTypeParam *string) (nsx_policyModel.SharedResourceListResult, error)
...
func NewResourcesClient(connector vapiProtocolClient_.Connector) *resourcesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.shares.resources")
...
func (rIface *resourcesClient) Get(orgIdParam string, projectIdParam string, shareIdParam string, sharedResourceIdParam string) (nsx_policyModel.SharedResource, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
...
func (rIface *resourcesClient) List(orgIdParam string, projectIdParam string, shareIdParam string, resourceTypeParam *string) (nsx_policyModel.SharedResourceListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
