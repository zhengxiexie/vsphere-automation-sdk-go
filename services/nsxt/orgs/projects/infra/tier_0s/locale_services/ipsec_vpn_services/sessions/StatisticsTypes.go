...
func statisticsCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/ipsec-vpn-services/{serviceId}/sessions/{sessionId}/statistics",
		"",
		resultHeaders,
		204,
		"",
