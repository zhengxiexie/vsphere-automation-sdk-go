...
type SummaryClient interface {
	...
	Get(orgIdParam string, projectIdParam string, tier0IdParam string, serviceIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyIpsecVpnIkeServiceSummary, error)
}
...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_0s.ipsec_vpn_services.summary")
...
func (sIface *summaryClient) Get(orgIdParam string, projectIdParam string, tier0IdParam string, serviceIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyIpsecVpnIkeServiceSummary, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_0s.ipsec_vpn_services.summary", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyIpsecVpnIkeServiceSummary
