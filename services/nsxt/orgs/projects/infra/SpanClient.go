...
func NewSpanClient(connector vapiProtocolClient_.Connector) *spanClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.span")
...
func (sIface *spanClient) Get(orgIdParam string, projectIdParam string, intentPathParam string, sitePathParam *string) (nsx_policyModel.Span, error) {
