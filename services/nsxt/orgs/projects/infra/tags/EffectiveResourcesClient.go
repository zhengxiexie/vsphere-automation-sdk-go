...
type EffectiveResourcesClient interface {
	...
	List(orgIdParam string, projectIdParam string, cursorParam *string, enforcementPointPathParam *string, filterByParam *string, filterTextParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, tagParam *string) (nsx_policyModel.PolicyResourceReferenceListResult, error)
}
...
func NewEffectiveResourcesClient(connector vapiProtocolClient_.Connector) *effectiveResourcesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tags.effective_resources")
...
func (eIface *effectiveResourcesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, enforcementPointPathParam *string, filterByParam *string, filterTextParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, tagParam *string) (nsx_policyModel.PolicyResourceReferenceListResult, error) {
