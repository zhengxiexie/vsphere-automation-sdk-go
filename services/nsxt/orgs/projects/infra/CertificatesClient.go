...
type CertificatesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, certificateIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, certificateIdParam string, detailsParam *bool) (nsx_policyModel.TlsCertificate, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_policyModel.TlsCertificateList, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, certificateIdParam string, tlsTrustDataParam nsx_policyModel.TlsTrustData) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, certificateIdParam string, tlsTrustDataParam nsx_policyModel.TlsTrustData) (nsx_policyModel.TlsCertificate, error)
}
...
func NewCertificatesClient(connector vapiProtocolClient_.Connector) *certificatesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.certificates")
...
func (cIface *certificatesClient) Delete(orgIdParam string, projectIdParam string, certificateIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.certificates", "delete", inputDataValue, executionContext)
...
func (cIface *certificatesClient) Get(orgIdParam string, projectIdParam string, certificateIdParam string, detailsParam *bool) (nsx_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.certificates", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *certificatesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_policyModel.TlsCertificateList, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.certificates", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCertificateList
	if methodResult.IsSuccess() {
...
func (cIface *certificatesClient) Patch(orgIdParam string, projectIdParam string, certificateIdParam string, tlsTrustDataParam nsx_policyModel.TlsTrustData) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.certificates", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *certificatesClient) Update(orgIdParam string, projectIdParam string, certificateIdParam string, tlsTrustDataParam nsx_policyModel.TlsTrustData) (nsx_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.certificates", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
