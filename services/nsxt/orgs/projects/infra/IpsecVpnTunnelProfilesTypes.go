...
func ipsecVpnTunnelProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipsec-vpn-tunnel-profiles/{tunnelProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipsecVpnTunnelProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipsec-vpn-tunnel-profiles",
		"",
		resultHeaders,
		200,
		"",
