...
type UsageClient interface {
	...
	Get(orgIdParam string, projectIdParam string, categoryParam *string, cursorParam *string, forceParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.CapacityUsageResponse, error)
}
...
func NewUsageClient(connector vapiProtocolClient_.Connector) *usageClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.capacity.dashboard.usage")
...
func (uIface *usageClient) Get(orgIdParam string, projectIdParam string, categoryParam *string, cursorParam *string, forceParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.CapacityUsageResponse, error) {
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.capacity.dashboard.usage", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.CapacityUsageResponse
