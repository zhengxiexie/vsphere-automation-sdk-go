...
type CrlsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, crlIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, crlIdParam string, detailsParam *bool) (nsx_policyModel.TlsCrl, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Importcrl(orgIdParam string, projectIdParam string, crlIdParam string, tlsCrlParam nsx_policyModel.TlsCrl) (nsx_policyModel.TlsCrlListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_policyModel.TlsCrlListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, crlIdParam string, tlsCrlParam nsx_policyModel.TlsCrl) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, crlIdParam string, tlsCrlParam nsx_policyModel.TlsCrl) (nsx_policyModel.TlsCrl, error)
}
...
func NewCrlsClient(connector vapiProtocolClient_.Connector) *crlsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.crls")
...
func (cIface *crlsClient) Delete(orgIdParam string, projectIdParam string, crlIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.crls", "delete", inputDataValue, executionContext)
...
func (cIface *crlsClient) Get(orgIdParam string, projectIdParam string, crlIdParam string, detailsParam *bool) (nsx_policyModel.TlsCrl, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.crls", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCrl
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) Importcrl(orgIdParam string, projectIdParam string, crlIdParam string, tlsCrlParam nsx_policyModel.TlsCrl) (nsx_policyModel.TlsCrlListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.crls", "importcrl", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCrlListResult
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_policyModel.TlsCrlListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.crls", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCrlListResult
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) Patch(orgIdParam string, projectIdParam string, crlIdParam string, tlsCrlParam nsx_policyModel.TlsCrl) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.crls", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *crlsClient) Update(orgIdParam string, projectIdParam string, crlIdParam string, tlsCrlParam nsx_policyModel.TlsCrl) (nsx_policyModel.TlsCrl, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.crls", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCrl
	if methodResult.IsSuccess() {
