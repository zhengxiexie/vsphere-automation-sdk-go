...
type LbServicesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, lbServiceIdParam string, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, lbServiceIdParam string) (nsx_policyModel.LBService, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBServiceListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, lbServiceIdParam string, lbServiceParam nsx_policyModel.LBService) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, lbServiceIdParam string, lbServiceParam nsx_policyModel.LBService) (nsx_policyModel.LBService, error)
}
...
func NewLbServicesClient(connector vapiProtocolClient_.Connector) *lbServicesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.lb_services")
...
func (lIface *lbServicesClient) Delete(orgIdParam string, projectIdParam string, lbServiceIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.lb_services", "delete", inputDataValue, executionContext)
...
func (lIface *lbServicesClient) Get(orgIdParam string, projectIdParam string, lbServiceIdParam string) (nsx_policyModel.LBService, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.lb_services", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBService
	if methodResult.IsSuccess() {
...
func (lIface *lbServicesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LBServiceListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.lb_services", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBServiceListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbServicesClient) Patch(orgIdParam string, projectIdParam string, lbServiceIdParam string, lbServiceParam nsx_policyModel.LBService) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.lb_services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbServicesClient) Update(orgIdParam string, projectIdParam string, lbServiceIdParam string, lbServiceParam nsx_policyModel.LBService) (nsx_policyModel.LBService, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.lb_services", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LBService
	if methodResult.IsSuccess() {
