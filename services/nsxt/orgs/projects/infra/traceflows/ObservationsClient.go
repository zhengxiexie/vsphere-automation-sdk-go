...
func NewObservationsClient(connector vapiProtocolClient_.Connector) *observationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.traceflows.observations")
...
func (oIface *observationsClient) List(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (nsx_policyModel.TraceflowObservationListResult, error) {
