...
type StatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (nsx_policyModel.Traceflow, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.traceflows.status")
...
func (sIface *statusClient) Get(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (nsx_policyModel.Traceflow, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.Traceflow
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.Traceflow), nil
	} else {
