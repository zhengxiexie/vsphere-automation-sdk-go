...
type PortDiscoveryProfileBindingMapsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, portDiscoveryProfileBindingMapIdParam string) (nsx_policyModel.PortDiscoveryProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PortDiscoveryProfileBindingMapListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, portDiscoveryProfileBindingMapIdParam string, portDiscoveryProfileBindingMapParam nsx_policyModel.PortDiscoveryProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, portDiscoveryProfileBindingMapIdParam string, portDiscoveryProfileBindingMapParam nsx_policyModel.PortDiscoveryProfileBindingMap) (nsx_policyModel.PortDiscoveryProfileBindingMap, error)
}
...
func NewPortDiscoveryProfileBindingMapsClient(connector vapiProtocolClient_.Connector) *portDiscoveryProfileBindingMapsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.ports.port_discovery_profile_binding_maps")
...
func (pIface *portDiscoveryProfileBindingMapsClient) Get(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, portDiscoveryProfileBindingMapIdParam string) (nsx_policyModel.PortDiscoveryProfileBindingMap, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
...
func (pIface *portDiscoveryProfileBindingMapsClient) List(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PortDiscoveryProfileBindingMapListResult, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
...
func (pIface *portDiscoveryProfileBindingMapsClient) Patch(orgIdParam string, projectIdParam string, infraSegmentIdParam string, infraPortIdParam string, portDiscoveryProfileBindingMapIdParam string, portDiscoveryProfileBindingMapParam nsx_policyModel.PortDiscoveryProfileBindingMap) error {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
