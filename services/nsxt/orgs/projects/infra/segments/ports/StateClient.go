...
type StateClient interface {
	...
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, portIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.SegmentPortState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.ports.state")
...
func (sIface *stateClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, portIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.SegmentPortState, error) {
