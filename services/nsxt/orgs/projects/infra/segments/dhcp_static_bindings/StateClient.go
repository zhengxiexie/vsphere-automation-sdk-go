...
type StateClient interface {
	...
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, bindingIdParam string) (nsx_policyModel.DhcpStaticBindingState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.dhcp_static_bindings.state")
...
func (sIface *stateClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, bindingIdParam string) (nsx_policyModel.DhcpStaticBindingState, error) {
