...
type OpsGlobalConfigClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, opsGlobalConfigParam nsx_policyModel.OpsGlobalConfig, applyLocallyParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, opsGlobalConfigParam nsx_policyModel.OpsGlobalConfig, applyLocallyParam *bool) (nsx_policyModel.OpsGlobalConfig, error)
}
...
func NewOpsGlobalConfigClient(connector vapiProtocolClient_.Connector) *opsGlobalConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ops_global_config")
...
func (oIface *opsGlobalConfigClient) Get(orgIdParam string, projectIdParam string, applyLocallyParam *bool) (nsx_policyModel.OpsGlobalConfig, error) {
	...
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ops_global_config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.OpsGlobalConfig
...
func (oIface *opsGlobalConfigClient) Patch(orgIdParam string, projectIdParam string, opsGlobalConfigParam nsx_policyModel.OpsGlobalConfig, applyLocallyParam *bool) error {
	typeConverter := oIface.connector.TypeConverter()
	executionContext := oIface.connector.NewExecutionContext()
	...
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ops_global_config", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), oIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (oIface *opsGlobalConfigClient) Update(orgIdParam string, projectIdParam string, opsGlobalConfigParam nsx_policyModel.OpsGlobalConfig, applyLocallyParam *bool) (nsx_policyModel.OpsGlobalConfig, error) {
	typeConverter := oIface.connector.TypeConverter()
	executionContext := oIface.connector.NewExecutionContext()
	...
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ops_global_config", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.OpsGlobalConfig
	if methodResult.IsSuccess() {
