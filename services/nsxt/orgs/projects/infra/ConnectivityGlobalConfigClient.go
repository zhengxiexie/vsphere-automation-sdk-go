...
type ConnectivityGlobalConfigClient interface {
	...
	Get(orgIdParam string, projectIdParam string, applyLocallyParam *bool) (nsx_policyModel.GlobalConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, globalConfigParam nsx_policyModel.GlobalConfig, applyLocallyParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, globalConfigParam nsx_policyModel.GlobalConfig, applyLocallyParam *bool) (nsx_policyModel.GlobalConfig, error)
}
...
func NewConnectivityGlobalConfigClient(connector vapiProtocolClient_.Connector) *connectivityGlobalConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.connectivity_global_config")
...
func (cIface *connectivityGlobalConfigClient) Get(orgIdParam string, projectIdParam string, applyLocallyParam *bool) (nsx_policyModel.GlobalConfig, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.connectivity_global_config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.GlobalConfig
...
func (cIface *connectivityGlobalConfigClient) Patch(orgIdParam string, projectIdParam string, globalConfigParam nsx_policyModel.GlobalConfig, applyLocallyParam *bool) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.connectivity_global_config", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *connectivityGlobalConfigClient) Update(orgIdParam string, projectIdParam string, globalConfigParam nsx_policyModel.GlobalConfig, applyLocallyParam *bool) (nsx_policyModel.GlobalConfig, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.connectivity_global_config", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.GlobalConfig
	if methodResult.IsSuccess() {
