...
type ResponseClient interface {
	...
	Get(taskIdParam string) (*vapiData_.StructValue, error)
}
...
func NewResponseClient(connector vapiProtocolClient_.Connector) *responseClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.tasks.response")
...
func (rIface *responseClient) Get(taskIdParam string) (*vapiData_.StructValue, error) {
